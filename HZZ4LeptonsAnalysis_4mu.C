...
void HZZ4LeptonsAnalysis::Loop(const Char_t *output)
{
   coutImpl cout;
   ...
   std::cout << "The output file is " << output << endl;
   TString out = output;
   ...
   std::cout << "Opening a txt file with candidate events " << txtOUT << endl;
   ofstream output_txt;
   output_txt.open(txtOUT);

   Char_t txtOUT_VBF[500];
   sprintf(txtOUT_VBF,"%s_txt_vbf.txt",datasetName.Data());
   std::cout << "Opening a txt file with candidate events " << txtOUT_VBF << endl;
   ...
   std::cout << "isSignal= " << isSignal << endl;

   char *basename(char *path);
   std::cout << "Basename " << basename(datasetChar) << endl;
   ...
   if ( datasetBase.Contains("2HDM") && datasetBase.Contains("Target") ){
     ...
     std::cout << "DatasetBase is= " << datasetBase.Data() << endl;
   }
   ...
   std::cout << "mhstring=" << mhstring << endl;
  
   float mHgen=0.;
   mHgen=atof(mhstring.Data());
   std::cout << "mHgen= " << mHgen << endl;
...
//   TH2F *mu_scale_2017 = (TH2F*)gDirectory->Get("FINAL"); 
   ...
   */
   ...
   TH1F * hPtMu_loose = new TH1F("hPtMu_loose", "hPtMu_loose",  200 , -0.5 , 199. );
   TH1F * hIsoMu_loose = new TH1F("hIsoMu_loose", "hIsoMu_loose",  2000 , -10. , 10. );
   TH1F * hSipMu_loose = new TH1F("hSipMu_loose", "hSipMu_loose",  1000 , -20. , 40. );
   TH1F * hDxyMu_loose = new TH1F("hDxyMu_loose", "hDxyMu_loose",  1000 , -10. , 10. );
   TH1F * hDzMu_loose = new TH1F("hDzMu_loose", "hDzMu_loose",  1000 , -10. , 10. );

   TH1F * hPtEle_loose = new TH1F("hPtEle_loose", "hPtEle_loose",  200 , -0.5 , 199. );
   TH1F * hIsoEle_loose = new TH1F("hIsoEle_loose", "hIsoEle_loose",  2000 , -10. , 10. );
   TH1F * hSipEle_loose = new TH1F("hSipEle_loose", "hSipEle_loose",  1000 , -20. , 40. );
   TH1F * hDxyEle_loose = new TH1F("hDxyEle_loose", "hDxyEle_loose",  1000 , -10. , 10. );
   TH1F * hDzEle_loose = new TH1F("hDzEle_loose", "hDzEle_loose",  1000 , -10. , 10. );

   TH1F * hPtMu_tight = new TH1F("hPtMu_tight", "hPtMu_tight",  200 , -0.5 , 199. );
   TH1F * hIsoMu_tight = new TH1F("hIsoMu_tight", "hIsoMu_tight",  2000 , -10. , 10. );
   TH1F * hSipMu_tight = new TH1F("hSipMu_tight", "hSipMu_tight",  1000 , -20. , 40. );
   TH1F * hDxyMu_tight = new TH1F("hDxyMu_tight", "hDxyMu_tight",  1000 , -10. , 10. );
   TH1F * hDzMu_tight = new TH1F("hDzMu_tight", "hDzMu_tight",  1000 , -10. , 10. );

   TH1F * hPtEle_tight = new TH1F("hPtEle_tight", "hPtEle_tight",  200 , -0.5 , 199. );
   TH1F * hIsoEle_tight = new TH1F("hIsoEle_tight", "hIsoEle_tight",  2000 , -10. , 10. );
   TH1F * hSipEle_tight = new TH1F("hSipEle_tight", "hSipEle_tight",  1000 , -20. , 40. );
   TH1F * hDxyEle_tight = new TH1F("hDxyEle_tight", "hDxyEle_tight",  1000 , -10. , 10. );
   TH1F * hDzEle_tight = new TH1F("hDzEle_tight", "hDzEle_tight",  1000 , -10. , 10. );
   ...
   TH1D * hN_bjets_loose = new TH1D("hN_bjets_loose", "hN_bjets_loose", 10, -0.5, 9.5);
   TH1D * hN_bjets_medium = new TH1D("hN_bjets_medium", "hN_bjets_medium", 10, -0.5, 9.5);
   TH1D * hN_bjets_tight = new TH1D("hN_bjets_tight", "hN_bjets_tight", 10, -0.5, 9.5);
   ...
   */
   ...
   for (Long64_t jentry=0; jentry<fChain->GetEntriesFast();jentry++) {
	...
	if(iparton < f_lhe_npartons){
      ...
      if(jentry%1 == 0) std::cout << "Analyzing entry: " << jentry << endl;   
	...
	if (safeAccess(MC_PT)[0] > 0.) {
	  Int_t binx = pTweighthisto->GetXaxis()->FindBin(safeAccess(MC_PT)[0]);
	...
	//  for(int f=0;f<9;f++) ggzz_kf_wgt[f] = ggZZ_kf[f]->Eval(safeAccess(MC_MASS)[0]); // Evaluate at the true m4l
    ...
    for (int l=0;l<MC_ZZ_MASS->size();++l){ //This originally looped to 4. Why loop when it just gets overwritten? Fix me
      ...
      //safeAccess(MC_PDGID)[0]  the Higgs25
      //safeAccess(MC_PDGID)[1]  the Z1   23
      //safeAccess(MC_PDGID)[2]  the Z2   23
      //safeAccess(MC_PDGID)[3]  the l1+  mu- = 13  e- = 11
      //safeAccess(MC_PDGID)[4]  the l2-  mu+ = -13  e+ = -11
      //safeAccess(MC_PDGID)[5]  the l3+  mu- = 13  e- = 11
      //safeAccess(MC_PDGID)[6]  the l4-  mu+ = -13  e+ = -11
     
      bool is4mu=false;
      int ilargesteta=-1;

      if( isSignal && debug ) cout << "\n ** Step 0.1 (MC truth): "
				   << "\nMC_PDGID[0] " << safeAccess(MC_PDGID)[0]
				   << "\nMC_PDGID[1] " << safeAccess(MC_PDGID)[1]	
				   << "\nMC_PDGID[2] " << safeAccess(MC_PDGID)[2]	
				   << "\nMC_PDGID[3] " << safeAccess(MC_PDGID)[3]	
				   << "\nMC_PDGID[4] " << safeAccess(MC_PDGID)[4]	
				   << "\nMC_PDGID[5] " << safeAccess(MC_PDGID)[5]	
				   << "\nMC_PDGID[6] " << safeAccess(MC_PDGID)[6]	
				   << endl ;
            
      //
      if (isSignal || isggH){
	if( safeAccess(MC_PDGID)[3] == 13 && safeAccess(MC_PDGID)[4] == -13  
	    && safeAccess(MC_PDGID)[5] == 13 && safeAccess(MC_PDGID)[6] == -13 ){
	  is4mu=true;
	  ++N_01 ;  // fill counter 
	...
	for( int i = 3; i  < 7; ++i){
	  ...
	  if( debug ) cout << "\n ** Step 0.2 (acceptance): "
			   << "\n fabs(safeAccess(MC_ETA)[i])" << fabs(safeAccess(MC_ETA)[i])	
			   << "\n safeAccess(MC_PT)[i]" << safeAccess(MC_PT)[i]	
			   << endl ;
	  
	  //if( (isSignal || isvbf) && (fabs(safeAccess(MC_ETA)[i]) >= 2.4 || safeAccess(MC_PT)[i] <= 5.) ){ 
	  if( (fabs(safeAccess(MC_ETA)[i]) >= 2.4) ){ // only eta cut NEW
	    isInAcceptance = 0;
	    break;        
	  }
	...
	if( is4mu && isInAcceptance )       {
	  ...
	  hgenmu_eta->Fill((safeAccess(MC_ETA)[3]),newweight);
	  hgenmu_eta->Fill((safeAccess(MC_ETA)[4]),newweight);
	  hgenmu_eta->Fill((safeAccess(MC_ETA)[5]),newweight);
	  hgenmu_eta->Fill((safeAccess(MC_ETA)[6]),newweight);
	  hgenmu_pt->Fill(safeAccess(MC_PT)[3]);
	  hgenmu_pt->Fill(safeAccess(MC_PT)[4]);
	  hgenmu_pt->Fill(safeAccess(MC_PT)[5]);
	  hgenmu_pt->Fill(safeAccess(MC_PT)[6]);

	  //vector<float> genpT;
	  //genpT.push_back(safeAccess(MC_PT)[3]);
	  //genpT.push_back(safeAccess(MC_PT)[4]);
	  //genpT.push_back(safeAccess(MC_PT)[5]);
	  //genpT.push_back(safeAccess(MC_PT)[6]);	  
	  //std::sort(genpT.rbegin(),genpT.rend());	  

	  hgenmu_largeta->Fill((safeAccess(MC_ETA)[ilargesteta]),newweight);
	  hgenmu_pt_largeta->Fill(safeAccess(MC_PT)[ilargesteta],newweight);
	  hgenmu_p_largeta->Fill(safeAccess(MC_PT)[ilargesteta]/sin(safeAccess(MC_THETA)[ilargesteta]),newweight);
	...
	if (safeAccess(RECOMU_PT)[i] <5.) continue;
	if( ( safeAccess(RECOMU_isGlobalMu)[i] || (safeAccess(RECOMU_isTrackerMu)[i] && safeAccess(RECOMU_numberOfMatches)[i]>0))){
	  hPtLep_0->Fill( safeAccess(RECOMU_PT)[i],newweight );
	  hIsoLep_0->Fill( safeAccess(RECOMU_PFX_dB)[i],newweight );
	  hSipLep_0->Fill( safeAccess(RECOMU_SIP)[i],newweight );
	  hDxyLep_0->Fill( safeAccess(RECOMU_mubesttrkDxy)[i],newweight );
	  hDzLep_0->Fill( safeAccess(RECOMU_mubesttrkDz)[i],newweight );
	  hMuHitLep_0->Fill( safeAccess(RECOMU_mutrkNMuonHits)[i],newweight );
	  hPxHitLep_0->Fill( safeAccess(RECOMU_muInnertrkNPixHits)[i],newweight );
	  hTKLayLep_0->Fill( safeAccess(RECOMU_muInnertrktrackerLayersWithMeasurement)[i],newweight );
	  hTKIsoLep_0->Fill( safeAccess(RECOMU_TRACKISO_SUMPT)[i],newweight );
	}
	
        if( debug ) cout << "\n Lepton i="<< i <<" properties: "
			 << "\nRECOMU_isGlobalMu[i] " << int(safeAccess(RECOMU_isGlobalMu)[i])
			 << "\nRECOMU_isTrackerMu[i] " << int(safeAccess(RECOMU_isTrackerMu)[i])
			 << "\nRECOMU_PT[i] " << safeAccess(RECOMU_PT)[i]
			 << "\nfabs(safeAccess(RECOMU_ETA)[i]) " << fabs(safeAccess(RECOMU_ETA)[i])
			 << "\nfabs( RECOMU_mubestrkDxy[i] ) " << fabs( safeAccess(RECOMU_mubesttrkDxy)[i] )
			 << "\nfabs( safeAccess(RECOMU_mubesttrkDz)[i] ) " << fabs( safeAccess(RECOMU_mubesttrkDz)[i] )
			 << endl ;
       	
 	if( ( safeAccess(RECOMU_isGlobalMu)[i] || (safeAccess(RECOMU_isTrackerMu)[i] && safeAccess(RECOMU_numberOfMatches)[i]>0) )
	    && safeAccess(RECOMU_mubesttrkType)[i]!=2
	    && safeAccess(RECOMU_PT)[i] > 5. 
	  ...
	  //loose muon distributions
	  
	  hPtMu_loose->Fill( safeAccess(RECOMU_PT)[i],newweight );
	  hIsoMu_loose->Fill( safeAccess(RECOMU_PFX_dB)[i],newweight );
	  hSipMu_loose->Fill( safeAccess(RECOMU_SIP)[i],newweight );
	  hDxyMu_loose->Fill( safeAccess(RECOMU_mubesttrkDxy)[i],newweight );
	...
	iL_loose_e[i]=-999.;
      ...
      for( int i = 0; i < RECO_NELE; ++i ){
        ...
        if( debug ) cout << "\n Lepton i="<< i <<" properties: "
			 << "\nRECOELE_PT[i] " << safeAccess(RECOELE_PT)[i]
			 << "\nfabs(safeAccess(RECOELE_ETA)[i]) " << fabs(safeAccess(RECOELE_ETA)[i])
			 << "\nfabs( safeAccess(RECOELE_gsftrack_dxy)[i] ) " << fabs( safeAccess(RECOELE_gsftrack_dxy)[i] )
			 << "\nfabs( safeAccess(RECOELE_gsftrack_dz)[i] ) " << fabs( safeAccess(RECOELE_gsftrack_dz)[i] )
			 << endl ;
       	
 	if( safeAccess(RECOELE_PT)[i] > 7. 
	    && fabs(safeAccess(RECOELE_ETA)[i]) < 2.5 
	    // && safeAccess(RECOELE_gsftrack_expected_inner_hits)[i]<=1 not used anymore
	  ...
	  //loose electron distributions

	  hPtEle_loose->Fill( safeAccess(RECOELE_PT)[i],newweight );
	  hIsoEle_loose->Fill( safeAccess(RECOELE_PFX_rho)[i],newweight );
	  hSipEle_loose->Fill( safeAccess(RECOELE_SIP)[i],newweight );
	  hDxyEle_loose->Fill( safeAccess(RECOELE_gsftrack_dxy)[i],newweight );
	  hDzEle_loose->Fill( safeAccess(RECOELE_gsftrack_dz)[i],newweight );
	}
	  ...
	  if( (safeAccess(RECOMU_isPFMu)[mu] || (safeAccess(RECOMU_isTrackerHighPtMu)[mu] && safeAccess(RECOMU_PT)[mu] > 200.))
	      && (safeAccess(RECOMU_isGlobalMu)[mu] || (safeAccess(RECOMU_isTrackerMu)[mu] && safeAccess(RECOMU_numberOfMatches)[mu]>0))
	      && safeAccess(RECOMU_mubesttrkType)[mu]!=2
	      && safeAccess(RECOMU_PT)[mu] > 5. 
	      && fabs(safeAccess(RECOMU_ETA)[mu]) < 2.4 
	      && fabs(safeAccess(RECOMU_mubesttrkDxy)[mu]) < .5 && fabs(safeAccess(RECOMU_mubesttrkDz)[mu]) < 1. 
	      && fabs(safeAccess(RECOMU_SIP)[mu])<4.  // TightID  + SIP cut
	      );
	  else continue;
	  
	  double deltaR = sqrt( pow( DELTAPHI( safeAccess(RECOMU_PHI)[mu] , safeAccess(RECOELE_PHI)[e] ),2) + pow(safeAccess(RECOMU_ETA)[mu] - safeAccess(RECOELE_ETA)[e],2) );
	  
	  if( deltaR <= 0.05 ){
	    
	    if( debug )cout << "Electrom not passing the cross cleaning" << endl;
	    
	    safeAccess(RECOELE_PT)[e]  = -0.01;
	    safeAccess(RECOELE_ETA)[e] = -99.;
	    safeAccess(RECOELE_PHI)[e] = -99.;
	    safeAccess(RECOELE_SIP)[e] = -99.;
	  }
	}
      ...
      for( int i = 0; i < RECO_NMU; ++i ){
        ...
        if( debug ) cout << "\n Lepton i="<< i <<" properties: "
			 << "\nRECOMU_isPFMu[i] " << int(safeAccess(RECOMU_isPFMu)[i])
			 << "\nRECOMU_isGlobalMu[i] " << int(safeAccess(RECOMU_isGlobalMu)[i])
			 << "\nRECOMU_isTrackerMu[i] " << int(safeAccess(RECOMU_isTrackerMu)[i])
			 << "\nRECOMU_PT[i] " << safeAccess(RECOMU_PT)[i]
			 << "\nfabs(safeAccess(RECOMU_ETA)[i]) " << fabs(safeAccess(RECOMU_ETA)[i])
			 << "\nRECOMU_PFX_dB[i] " << safeAccess(RECOMU_PFX_dB)[i]
			 << "\nfabs( safeAccess(RECOMU_SIP)[i] ) " << fabs( safeAccess(RECOMU_SIP)[i] )
			 << "\nfabs( safeAccess(RECOMU_mubesttrkDxy)[i] ) " << fabs( safeAccess(RECOMU_mubesttrkDxy)[i] )
			 << "\nfabs( safeAccess(RECOMU_mubesttrkDz)[i] ) " << fabs( safeAccess(RECOMU_mubesttrkDz)[i] )
			 <<"\n charge = "<<safeAccess(RECOMU_CHARGE)[i]
			 << endl ;
	
       	// Tight muons
 	if( (safeAccess(RECOMU_isPFMu)[i] || (safeAccess(RECOMU_isTrackerHighPtMu)[i] && safeAccess(RECOMU_PT)[i] > 200.))
	    && ( safeAccess(RECOMU_isGlobalMu)[i] || (safeAccess(RECOMU_isTrackerMu)[i] && safeAccess(RECOMU_numberOfMatches)[i]>0))
	    && safeAccess(RECOMU_mubesttrkType)[i]!=2	 
	    && safeAccess(RECOMU_PT)[i] > 5. 
	    && fabs(safeAccess(RECOMU_ETA)[i]) < 2.4 
	    && fabs(safeAccess(RECOMU_mubesttrkDxy)[i]) < .5 && fabs(safeAccess(RECOMU_mubesttrkDz)[i]) < 1.
	  ...
	  //Tight muon distributions
	  
	  hPtMu_tight->Fill( safeAccess(RECOMU_PT)[i],newweight );
	  hIsoMu_tight->Fill( safeAccess(RECOMU_PFX_dB)[i],newweight );
	  hSipMu_tight->Fill( safeAccess(RECOMU_SIP)[i],newweight );
	  hDxyMu_tight->Fill( safeAccess(RECOMU_mubesttrkDxy)[i],newweight );
	  hDzMu_tight->Fill( safeAccess(RECOMU_mubesttrkDz)[i],newweight );
      ...
      // for (int i=0;i<100;i++){
      // 	RECOMU_PFX_dB_new[i]=safeAccess(RECOMU_PFX_dB)[i];
      // 	RECOELE_PFX_rho_new[i]=safeAccess(RECOELE_PFX_rho)[i];
      // }
      // //
      ...
      for( int i = 0; i < RECO_NELE; ++i ){
        ...
        if( debug ) cout << "\n Electron i="<< i <<" properties: "
      		  << "\nRECOELE_PT[i] " << safeAccess(RECOELE_PT)[i]
      		  << "\nfabs(safeAccess(RECOELE_ETA)[i]) " << fabs(safeAccess(RECOELE_ETA)[i])
		  << "\nfabs(safeAccess(RECOELE_scl_Eta)[i]) " << fabs(safeAccess(RECOELE_scl_Eta)[i])
      		  << "\nRECOELE_PFX_rho[i] " << safeAccess(RECOELE_PFX_rho)[i]
      		  << "\nfabs( safeAccess(RECOELE_SIP)[i] ) " << fabs( safeAccess(RECOELE_SIP)[i] )
      		  << "\nRECOELE_mvaNonTrigV0[i] " << safeAccess(RECOELE_mvaNonTrigV0)[i]
		  << "\nfabs( safeAccess(RECOELE_gsftrack_dxy)[i] ) " << fabs( safeAccess(RECOELE_gsftrack_dxy)[i] )
      		  << "\nfabs( safeAccess(RECOELE_gsftrack_dz)[i] ) " << fabs( safeAccess(RECOELE_gsftrack_dz)[i] )
		  << endl ;
       	
 	if( safeAccess(RECOELE_PT)[i] > 7. && fabs(safeAccess(RECOELE_ETA)[i]) < 2.5 );
	  //&& safeAccess(RECOELE_gsftrack_expected_inner_hits)[i]<=1 ) /* ok */ ;
	else continue ;
	
	bool BDT_ok = 0; // Spring16 with CMSSW_8_2_0
	// if( safeAccess(RECOELE_PT)[i] > 7. &&  safeAccess(RECOELE_PT)[i] <= 10. ){
	// 	if( fabs(safeAccess(RECOELE_scl_Eta)[i]) < .8 && safeAccess(RECOELE_mvaNonTrigV0)[i] > 0.5739521065342641 ) BDT_ok = 1 ;
	// 	if( ( fabs(safeAccess(RECOELE_scl_Eta)[i]) >= .8 && fabs(safeAccess(RECOELE_scl_Eta)[i]) < 1.479 )
	// 					 && safeAccess(RECOELE_mvaNonTrigV0)[i] > 0.5504628790992929 ) BDT_ok = 1 ;
	// 	if( fabs(safeAccess(RECOELE_scl_Eta)[i]) >= 1.479 && safeAccess(RECOELE_mvaNonTrigV0)[i] > 0.5924627534389098 ) BDT_ok = 1 ;
	// }
	// else { 
	// 	if( fabs(safeAccess(RECOELE_scl_Eta)[i]) < .8 && safeAccess(RECOELE_mvaNonTrigV0)[i] > -0.03391387993354392 ) BDT_ok = 1 ;
	// 	if( ( fabs(safeAccess(RECOELE_scl_Eta)[i]) >= .8 && fabs(safeAccess(RECOELE_scl_Eta)[i]) <= 1.479 )
	// 					 && safeAccess(RECOELE_mvaNonTrigV0)[i] > -0.018451958064666783 ) BDT_ok = 1 ;
	// 	if( fabs(safeAccess(RECOELE_scl_Eta)[i]) > 1.479 && safeAccess(RECOELE_mvaNonTrigV0)[i] > -0.38565459150737535 ) BDT_ok = 1 ;
	// }

	if( safeAccess(RECOELE_PT)[i] > 7. && safeAccess(RECOELE_ID)[i]==1 ){BDT_ok =1;};
	if( !BDT_ok ) continue ;
	
	if( fabs(safeAccess(RECOELE_gsftrack_dxy)[i]) < .5 
	 && fabs(safeAccess(RECOELE_gsftrack_dz)[i])  < 1. ) /* ok */ ;
	else continue ; 
		
	iLe[ Ne_good ] = i ;
	++Ne_good ;

	//Tight electron distributions
	
	hPtEle_tight->Fill( safeAccess(RECOELE_PT)[i],newweight );
	hIsoEle_tight->Fill( safeAccess(RECOELE_PFX_rho)[i],newweight );
	hSipEle_tight->Fill( safeAccess(RECOELE_SIP)[i],newweight );
	hDxyEle_tight->Fill( safeAccess(RECOELE_gsftrack_dxy)[i],newweight );
	hDzEle_tight->Fill( safeAccess(RECOELE_gsftrack_dz)[i],newweight );
      ...
      // Define a new isolation array to allocate the contribution of photons
      float RECOMU_PFX_dB_new[100],RECOELE_PFX_rho_new[100];  //Reham uncomment
      for (int i=0;i<100;i++){
	RECOMU_PFX_dB_new[i]=safeAccess(RECOMU_PFX_dB)[i];
	RECOELE_PFX_rho_new[i]=safeAccess(RECOELE_PFX_rho)[i];
      }
      ...
      for( int i = 0; i < RECO_NPFPHOT; ++i ){
        ...
        if( debug ) cout << "\n Photon i="<< i <<" properties: "
			 << "\n safeAccess(RECOPFPHOT_PT)[i] " << safeAccess(RECOPFPHOT_PT)[i]
			 << "\n fabs(safeAccess(RECOPFPHOT_ETA)[i]) " << fabs(safeAccess(RECOPFPHOT_ETA)[i])
			 << "\n safeAccess(RECOPFPHOT_PHI)[i] " << safeAccess(RECOPFPHOT_PHI)[i]
			 << "\n safeAccess(RECOPFPHOT_PFchHad)[i] " << safeAccess(RECOPFPHOT_PFchHad)[i] 
			 << "\n safeAccess(RECOPFPHOT_PFneuHad)[i] " << safeAccess(RECOPFPHOT_PFneuHad)[i] 
			 << "\n safeAccess(RECOPFPHOT_PFphoton)[i] " << safeAccess(RECOPFPHOT_PFphoton)[i] 
			 << "\n safeAccess(RECOPFPHOT_PFPUchAllPart)[i] "<< safeAccess(RECOPFPHOT_PFPUchAllPart)[i] 
			 << "\n safeAccess(RECOPFPHOT_PFX_rho)[i] " << safeAccess(RECOPFPHOT_PFX_rho)[i]
			 << endl ;
	
	if ( safeAccess(RECOPFPHOT_PT)[i] > 2. && fabs(safeAccess(RECOPFPHOT_ETA)[i]) < 2.4 && safeAccess(RECOPFPHOT_PFX_rho)[i]<1.8) { 
	  
	  bool is_clean = 1;
	  
	  // cleaning
	  for(int e = 0; e < N_loose_e; ++e){
  	    if (fabs( safeAccess(RECOELE_SIP)[iL_loose_e[e]])>=4.) continue; // loose ID + SIP cut
	    double deltaPhi = DELTAPHI( safeAccess(RECOPFPHOT_PHI)[i] , safeAccess(RECOELE_scl_Phi)[iL_loose_e[e]] ) ;
	    double deltaEta = fabs( safeAccess(RECOPFPHOT_ETA)[i] - safeAccess(RECOELE_scl_Eta)[iL_loose_e[e]] );
	    double deltaR = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[i] , safeAccess(RECOELE_scl_Phi)[iL_loose_e[e]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[i] - safeAccess(RECOELE_scl_Eta)[iL_loose_e[e]],2) );
	...
	cout <<  safeAccess(RECOPFPHOT_PT)[iLp[i]] << endl;
	double min_deltaR = 1000;
	int  l_min_deltaR = -1;
	int  tag_min_deltaR = -1;   // 0: mu  1: ele
	
	for(int l = 0; l < N_loose_mu; ++l){ // loop on muons
	  if (fabs(safeAccess(RECOMU_SIP)[iL_loose_mu[l]])>=4.) continue; //loose ID + SIP cut	  
	  double deltaR = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[iLp[i]] , safeAccess(RECOMU_PHI)[iL_loose_mu[l]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[iLp[i]] - safeAccess(RECOMU_ETA)[iL_loose_mu[l]],2) );
	  if(!(deltaR < 0.5 && deltaR/pow(safeAccess(RECOPFPHOT_PT)[iLp[i]],2)<0.012) ) continue;
	  //cout << "DeltaR= " << deltaR << endl;
	  if( deltaR<min_deltaR) { // the closest lepton
	    cout << "Possible candidate of photon with pT= " << safeAccess(RECOPFPHOT_PT)[iLp[i]] << " associated to a muon with pT= " << safeAccess(RECOMU_PT)[iL_loose_mu[l]]<< endl;
	    min_deltaR = deltaR;
	    l_min_deltaR = l;
	    tag_min_deltaR = 0;
	  }	  
	...
	for(int l = 0; l < N_loose_e; ++l){ // loop on electrons
	  if (fabs(safeAccess(RECOELE_SIP)[iL_loose_e[l]])>=4.) continue;  //loose ID + SIP cut
	  double deltaR = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[iLp[i]] , safeAccess(RECOELE_PHI)[iL_loose_e[l]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[iLp[i]] - safeAccess(RECOELE_ETA)[iL_loose_e[l]],2) );
	  if(!(deltaR < 0.5 && deltaR/pow(safeAccess(RECOPFPHOT_PT)[iLp[i]],2)<0.012) ) continue;
	  if( deltaR<min_deltaR) { // the closest lepton
	    cout << "Possible candidate of photon with pT= " << safeAccess(RECOPFPHOT_PT)[iLp[i]] << " associated to an electron with pT= " << safeAccess(RECOELE_PT)[iL_loose_e[l]]<< endl;
	    min_deltaR = deltaR;
	    l_min_deltaR = l;
	    tag_min_deltaR = 1;
	  }
	...
	if( min_deltaR < 0.5 ){
      ...
      // for(int i=0.;i<Nphotons;i++) {
      // 	if (iLp_l[i]!=-1 && iLp_tagEM[i]==0) cout << "There is photon with pT= " << safeAccess(RECOPFPHOT_PT)[iLp[i]] << " attached to a muon with pT= " << safeAccess(RECOMU_PT)[iLp_l[i]] << endl;
      // };
	...
	for( int p = 0; p < Nphotons; ++p ){
	  if( iLp_l[ p ] == iL_loose_mu[l] && iLp_tagEM[ p ] == 0 )  {
	    ...
	    double deltaR = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[iLp[p]] , safeAccess(RECOMU_PHI)[iL_loose_mu[l]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[iLp[p]] - safeAccess(RECOMU_ETA)[iL_loose_mu[l]],2) );
	    double deltaR_ET2 = deltaR/pow(safeAccess(RECOPFPHOT_PT)[iLp[p]],2);
	...
	for( int p = 0; p < Nphotons; ++p ){
	  if( iLp_l[ p ] == iL_loose_e[l] && iLp_tagEM[ p ] == 1 )  {
	    ...
	    double deltaR = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[iLp[p]] , safeAccess(RECOELE_PHI)[iL_loose_e[l]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[iLp[p]] - safeAccess(RECOELE_ETA)[iL_loose_e[l]],2));
	    double deltaR_ET2 = deltaR/pow(safeAccess(RECOPFPHOT_PT)[iLp[p]],2);
	...
	for(int e = 0; e < N_loose_e; ++e){
	  ...
	  if (fabs( safeAccess(RECOELE_SIP)[iL_loose_e[e]])>=4.) continue;
	  //double deltaR = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[iLp[i]] , safeAccess(RECOELE_scl_Phi)[iL_loose_e[e]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[iLp[i]] - safeAccess(RECOELE_scl_Eta)[iL_loose_e[e]],2) );
	  double deltaR = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[iLp[i]] , safeAccess(RECOELE_PHI)[iL_loose_e[e]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[iLp[i]] - safeAccess(RECOELE_ETA)[iL_loose_e[e]],2) );          cout << "deltaR for photon subtraction= " << deltaR << endl;
	  if( deltaR<=0.3 && (safeAccess(RECOELE_scl_Eta)[iL_loose_e[e]]< 1.479 || deltaR>0.08) ){ // 0.3 in 76x              
	    ...
	    RECOELE_PFX_rho_new[iL_loose_e[e]]=
              (safeAccess(RECOELE_PFchHad)[iL_loose_e[e]]+
               max(0.,safeAccess(RECOELE_PFneuHad)[iL_loose_e[e]]+
                   (safeAccess(RECOELE_PFphoton)[iL_loose_e[e]]-safeAccess(RECOPFPHOT_PT)[iLp[i]] )-
                   max(RHO_ele,0.0)*(EffectiveArea)))/safeAccess(RECOELE_PT)[iL_loose_e[e]];	    
	  }
	} // end loop on ele
	
	for(int l = 0; l < N_loose_mu; ++l){ // loop on muons
	  //if(!( iLp_l[i] == iL_loose_mu[l] && iLp_tagEM[i] == 0 ) ) continue;  // subtracting the photon contribution from all the leptons 
          if (fabs(safeAccess(RECOMU_SIP)[iL_loose_mu[l]])>=4.) continue;
          double deltaR = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[iLp[i]] , safeAccess(RECOMU_PHI)[iL_loose_mu[l]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[iLp[i]] - safeAccess(RECOMU_ETA)[iL_loose_mu[l]],2) );
	  ...
	  if( deltaR<=0.3 && deltaR>0.01){ // 0.3 is the isolation cone for muons in 76x
	    ...
	    RECOMU_PFX_dB_new[iL_loose_mu[l]]=
              (safeAccess(RECOMU_PFchHad)[iL_loose_mu[l]]+
               max(0.,safeAccess(RECOMU_PFneuHad)[iL_loose_mu[l]]+
                   (safeAccess(RECOMU_PFphoton)[iL_loose_mu[l]]-safeAccess(RECOPFPHOT_PT)[iLp[i]] )-
                   0.5*safeAccess(RECOMU_PFPUchAllPart)[iL_loose_mu[l]]))/safeAccess(RECOMU_PT)[iL_loose_mu[l]];
	...
	float ptFSR;
	  ...
	  cout<<"MuonspTs=" <<safeAccess(RECOMU_PT)[iL[i]]<<", "<<safeAccess(RECOMU_PT)[iL[j]] <<" ISO = "<<fabs(RECOMU_PFX_dB_new[iL[i]])<<" ,"<<fabs(RECOMU_PFX_dB_new[iL[j]])<<" SIP"<<safeAccess(RECOMU_SIP)[iL[i]]<<" ,"<<safeAccess(RECOMU_SIP)[iL[j]]<<endl;

	  if (fabs(safeAccess(RECOMU_SIP)[iL[i]])>=4.) continue;  // SIP cut for Z1 leptons
	  if (fabs(safeAccess(RECOMU_SIP)[iL[j]])>=4.) continue;
	  if (fabs(RECOMU_PFX_dB_new[iL[i]])>=0.35) continue; // Isolation cut
	  if (fabs(RECOMU_PFX_dB_new[iL[j]])>=0.35) continue;	  
	  
	  if(safeAccess(RECOMU_CHARGE)[ iL[j] ] == safeAccess(RECOMU_CHARGE)[ iL[i] ]) continue; // opposite charge

	  cout << "Pairing muons with pT= " << safeAccess(RECOMU_PT)[ iL[i] ] << " and " <<  safeAccess(RECOMU_PT)[ iL[j] ] << endl;
	  ...
	  float pTphot=-999.;
	  Lepton1.SetPtEtaPhiM(safeAccess(RECOMU_PT)[iL[i]], safeAccess(RECOMU_ETA)[iL[i]], safeAccess(RECOMU_PHI)[iL[i]], 0.105);
	  Lepton2.SetPtEtaPhiM(safeAccess(RECOMU_PT)[iL[j]], safeAccess(RECOMU_ETA)[iL[j]], safeAccess(RECOMU_PHI)[iL[j]], 0.105);
	  ...
	  for( int p = 0; p < Nphotons; ++p ){
	    if( iLp_l[ p ] == iL[i] && iLp_tagEM[ p ] == 0 )  {  // exists a photon asosciated to a lepton mu
	      ...
	      LeptonCorrection.SetPtEtaPhiM(safeAccess(RECOPFPHOT_PT)[iLp[p]],safeAccess(RECOPFPHOT_ETA)[iLp[p]],safeAccess(RECOPFPHOT_PHI)[iLp[p]],0);
	      ...
	      pi = p; 
	      ++N_FSR_Z;
	      if( safeAccess(RECOPFPHOT_PT)[iLp[p]] > max_pt_FSR_Z ) max_pt_FSR_Z = safeAccess(RECOPFPHOT_PT)[iLp[p]];
	      massZ=mllp;
	  ...
	  if( has_FSR_Z ){ // if Z has FSR
	    ...
	    if( debug ) cout  << "Z Isolation (not corrected for photon): "
                              << "\n safeAccess(RECOMU_PFX_dB)[ iL[i] ] " << safeAccess(RECOMU_PFX_dB)[ iL[i] ]
                              << "\n safeAccess(RECOMU_PFX_dB)[ iL[j] ] " << safeAccess(RECOMU_PFX_dB)[ iL[j] ]
                              << endl;
	    	   
	    if( pi != -1 ){
	      //double deltaR_i = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[iLp[pi]] , safeAccess(RECOMU_PHI)[iL[i]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[iLp[pi]] - safeAccess(RECOMU_ETA)[iL[i]],2) );
              //if( deltaR_i < 0.4 && deltaR_i > 0.01 )
	      pTphot=safeAccess(RECOPFPHOT_PT)[iLp[pi]];	      
	    }
	    else if( pj != -1 ){	      
              //double deltaR_j = sqrt( pow( DELTAPHI( safeAccess(RECOPFPHOT_PHI)[iLp[pj]] , safeAccess(RECOMU_PHI)[iL[j]] ),2) + pow(safeAccess(RECOPFPHOT_ETA)[iLp[pj]] - safeAccess(RECOMU_ETA)[iL[j]],2) );
              //if( deltaR_j < 0.4 && deltaR_j > 0.01 )
	      pTphot=safeAccess(RECOPFPHOT_PT)[iLp[pj]];	      
	    }
	  ...
	  Z->ilept1=iL[i];
	  Z->ilept2=iL[j];
	  Z->pt1=safeAccess(RECOMU_PT)[iL[i]];
	  Z->pt2=safeAccess(RECOMU_PT)[iL[j]];
	  Z->eta1=safeAccess(RECOMU_ETA)[iL[i]];
	  Z->eta2=safeAccess(RECOMU_ETA)[iL[j]];
	  Z->phi1=safeAccess(RECOMU_PHI)[iL[i]];
	  Z->phi2=safeAccess(RECOMU_PHI)[iL[j]];
	  Z->charge1=safeAccess(RECOMU_CHARGE)[iL[i]];
	  Z->charge2=safeAccess(RECOMU_CHARGE)[iL[j]];
	...
	int z1lept[2]={ipt1_3,ipt2_3};
        ...
        for(int i = 0; i < 2; ++i){
	  Double_t Pt = safeAccess(RECOMU_PT)[ z1lept[i] ]; 
	...
	hPtLep_3->Fill( safeAccess(RECOMU_PT)[ ipt1_3 ],newweight );
	hYLep_3->Fill( safeAccess(RECOMU_ETA)[ ipt1_3 ],newweight );
	hIsoLep_3->Fill( RECOMU_PFX_dB_new[ ipt1_3 ],newweight );
	hSipLep_3->Fill( safeAccess(RECOMU_SIP)[ ipt1_3 ],newweight );
	hIpLep_3->Fill( safeAccess(RECOMU_IP)[ ipt1_3 ],newweight );
	hIpErLep_3->Fill( safeAccess(RECOMU_IPERROR)[ ipt1_3 ],newweight );
	
	
	hPtLep_3->Fill( safeAccess(RECOMU_PT)[ ipt2_3 ],newweight );
	hYLep_3->Fill( safeAccess(RECOMU_ETA)[ ipt2_3 ],newweight );
	hIsoLep_3->Fill( RECOMU_PFX_dB_new[ ipt2_3 ],newweight );
	hSipLep_3->Fill( safeAccess(RECOMU_SIP)[ ipt2_3 ],newweight );
	hIpLep_3->Fill( safeAccess(RECOMU_IP)[ ipt2_3 ],newweight );
	hIpErLep_3->Fill( safeAccess(RECOMU_IPERROR)[ ipt2_3 ],newweight );
	...
	hMZ_3->Fill(Zcandisolmassvector.at(index).massvalue,newweight );
	  ...
	  <<"\n RECO_PFMET_EEBadScNoiseFilter = "<< RECO_PFMET_EEBadScNoiseFilter
      ...
      if (pass_METFilters){ hPFMET_3->Fill(RECO_PFMET,newweight);
	...
	if( safeAccess(RECOMU_isPFMu)[i] 
	    && ( safeAccess(RECOMU_isGlobalMu)[i] || safeAccess(RECOMU_isTrackerMu)[i] )
	    && ( safeAccess(RECOMU_isTrackerMu)[i] && !safeAccess(RECOMU_isGlobalMu)[i] && safeAccess(RECOMU_trkmuArbitration)[i] )
	    && safeAccess(RECOMU_PT)[i] > 5. && fabs(safeAccess(RECOMU_ETA)[i]) < 2.4 
	    && fabs(safeAccess(RECOMU_mubesttrkDxy)[i]) < .5 && fabs(safeAccess(RECOMU_mubesttrkDz)[i]) < 1.
	    ){
	  if( safeAccess(RECOMU_PFX_dB)[i] > max_Iso_3 ) max_Iso_3 = safeAccess(RECOMU_PFX_dB)[i] ;
	  if( fabs( safeAccess(RECOMU_SIP)[i] ) > max_Sip_3 ) max_Sip_3 = fabs( safeAccess(RECOMU_SIP)[i] ) ;
	  if( fabs( safeAccess(RECOMU_IP)[i] ) > max_Ip_3 ) max_Ip_3 = fabs( safeAccess(RECOMU_IP)[i] ) ;
	}
      }
	...
	//cout<<i<<" Jet with pt= "<<safeAccess(RECO_PFJET_PT)[i]<<" ETA "<<safeAccess(RECO_PFJET_ETA)[i]<<" PUID "<<safeAccess(RECO_PFJET_PUID)[i]<<endl;
	if(safeAccess(RECO_PFJET_PUID)[i]==1 && safeAccess(RECO_PFJET_PT)[i]>30. && fabs(safeAccess(RECO_PFJET_ETA)[i])<4.7 ){
	  //Check that jet has deltaR>0.4 away from any tight lepton 
	  
	  for(int mu = 0; mu < N_good; ++mu){
	    if (safeAccess(RECOMU_SIP)[iL[mu]]>=4.) continue;
	    if (RECOMU_PFX_dB_new[iL[mu]]>=0.35) continue;
	    deltaR_3 = sqrt( pow(DELTAPHI(safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECOMU_PHI)[iL[mu]]),2) + pow(safeAccess(RECO_PFJET_ETA)[i] - safeAccess(RECOMU_ETA)[iL[mu]],2));
	  ...
	  for(int ele = 0; ele < Ne_good; ++ele){
	    if (safeAccess(RECOELE_SIP)[iLe[ele]]>=4.) continue;
	    if (safeAccess(RECOELE_PFX_rho)[iLe[[ele]]>=0.5) continue;
	    deltaR_3 = sqrt( pow(DELTAPHI(safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECOELE_PHI)[iLe[ele]]),2) + pow(safeAccess(RECO_PFJET_ETA)[i] - safeAccess(RECOELE_ETA)[iLe[ele]],2));
	    cout << "1st lepton: " <<" deltaR "<< deltaR_3 <<endl;
	    if (deltaR_3<0.4){
	      jetfail_3[i]=1;
	      cout << " jetfail " << jetfail_3[i] <<endl;
	  ...
	  //if (FSR_Z1_lepid != -1){
	  //  //cout<<"photon phi "<<safeAccess(RECOPFPHOT_PHI)[FSR_Z1_photid]<<" photon eta "<<safeAccess(RECOPFPHOT_ETA)[FSR_Z1_photid]<<endl;
	  //  deltaR_3 = sqrt( pow(DELTAPHI(safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECOPFPHOT_PHI)[FSR_Z1_photid]),2) + pow(safeAccess(RECO_PFJET_ETA)[i] - safeAccess(RECOPFPHOT_ETA)[FSR_Z1_photid],2));
	  ...
	  if (jetfail_3[i]==0){
	    cout<< " PASS jet " <<i<<" PT= "<<safeAccess(RECO_PFJET_PT)[i]<<" ETA= "<<safeAccess(RECO_PFJET_ETA)[i]<<" PUID= "<<safeAccess(RECO_PFJET_PUID)[i]<<endl;
	    njets_pass_3++;
	  }
	}
	else{
	...
	//cout<<" JETFAIL "<<jetfail_3[i]<<endl;
     ...
     for (int i=0;i<RECO_PFJET_N;i++){
       ...
       for (int j=i+1;j<RECO_PFJET_N;j++){
         ...
         JET1_VBF_3.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[i],safeAccess(RECO_PFJET_ETA)[i],safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECO_PFJET_ET)[i]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[i]));
         JET2_VBF_3.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[j],safeAccess(RECO_PFJET_ETA)[j],safeAccess(RECO_PFJET_PHI)[j],safeAccess(RECO_PFJET_ET)[j]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[j]));
	...
	for (int i=0;i<4;i++){ 
	  for (int j=i+1;j<4;j++){
	    ...
	    if ( safeAccess(RECOMU_CHARGE)[ileptonsmumu.at(i)] == safeAccess(RECOMU_CHARGE)[ileptonsmumu.at(j)] ) continue; // shoud be OS	  
	    // evaluate the mass
	    double mass;
	    
	    Lepton1qcd.SetPtEtaPhiM(safeAccess(RECOMU_PT)[ileptonsmumu.at(i)], safeAccess(RECOMU_ETA)[ileptonsmumu.at(i)], safeAccess(RECOMU_PHI)[ileptonsmumu.at(i)], 0.000511);
	    Lepton2qcd.SetPtEtaPhiM(safeAccess(RECOMU_PT)[ileptonsmumu.at(j)], safeAccess(RECOMU_ETA)[ileptonsmumu.at(j)], safeAccess(RECOMU_PHI)[ileptonsmumu.at(j)], 0.000511);
	...
	if (pTcleanedgoodZ.at(i).ilept1_FSR) {
	  for( int p = 0; p < Nphotons; ++p ){
	    if( iLp_l[ p ] == pTcleanedgoodZ.at(i).ilept1 && iLp_tagEM[ p ] == 1 ){
	      Lepton1Correction.SetPtEtaPhiM(safeAccess(RECOPFPHOT_PT)[iLp[p]],safeAccess(RECOPFPHOT_ETA)[iLp[p]],safeAccess(RECOPFPHOT_PHI)[iLp[p]],0);
	...
	if (pTcleanedgoodZ.at(i).ilept2_FSR) {
	  for( int p = 0; p < Nphotons; ++p ){
	    if( iLp_l[ p ] == pTcleanedgoodZ.at(i).ilept2 && iLp_tagEM[ p ] == 1 ){
	      Lepton2Correction.SetPtEtaPhiM(safeAccess(RECOPFPHOT_PT)[iLp[p]],safeAccess(RECOPFPHOT_ETA)[iLp[p]],safeAccess(RECOPFPHOT_PHI)[iLp[p]],0);
	...
	for (int j=i+1;j<pTcleanedgoodZ.size();j++){
	  ...
	  if (pTcleanedgoodZ.at(j).ilept1_FSR) {
		...
		Lepton3Correction.SetPtEtaPhiM(safeAccess(RECOPFPHOT_PT)[iLp[p]],safeAccess(RECOPFPHOT_ETA)[iLp[p]],safeAccess(RECOPFPHOT_PHI)[iLp[p]],0);
	  ...
	  if (pTcleanedgoodZ.at(j).ilept2_FSR) {
		...
		Lepton4Correction.SetPtEtaPhiM(safeAccess(RECOPFPHOT_PT)[iLp[p]],safeAccess(RECOPFPHOT_ETA)[iLp[p]],safeAccess(RECOPFPHOT_PHI)[iLp[p]],0);
	...
	for (int ll=0;ll<vindexZZ.size();ll++){
     ...
     cout << "PTs= " << safeAccess(RECOMU_PT)[indexlep1Z1] << " " << safeAccess(RECOMU_PT)[indexlep2Z1] << " " <<  safeAccess(RECOMU_PT)[indexlep1Z2] << " " << safeAccess(RECOMU_PT)[indexlep2Z2]<< endl; 
	...
	N_4c_w=N_4c_w+newweight;
      ...
      for(int i = 0; i < 4; ++i){	
       	Double_t Pt = safeAccess(RECOMU_PT)[ iL_4L[i] ]; 
       	Double_t Eta = safeAccess(RECOMU_ETA)[ iL_4L[i] ]; 
	...
	if(  /*MC_type == "Fall17"  &&*/ DATA_type == "NO"){
      ...
      cout << "PTs= " << safeAccess(RECOMU_PT)[indexleptonfinal[0]] << " " << safeAccess(RECOMU_PT)[indexleptonfinal[1]] << " " <<  safeAccess(RECOMU_PT)[indexleptonfinal[2]] << " " << safeAccess(RECOMU_PT)[indexleptonfinal[3]]<< endl;

      for(int i = 0; i < 4; ++i) tmp_pt[i] =  safeAccess(RECOMU_PT)[indexleptonfinal[i]];
      for(int i = 0; i < 4; ++i){
        double tmp_max_pt = 0;
      	int jj = i;
        for(int j = 0; j < 4; ++j){
      ...
      if(debug)
      	  for(int i = 0; i < 4; ++i)
      	  	cout << "\n ipt[" << i << "] = " << ipt[i] << "\t pt = " << safeAccess(RECOMU_PT)[ ipt[i] ] << endl; 
      //end sorting
	...
	for( int p = 0; p < Nphotons; ++p ){
	  if( iLp_l[ p ] == ipt[i] && iLp_tagEM[ p ] == 0 )  {
	    cout << "muons with pT= " << safeAccess(RECOMU_PT)[ipt[i]] << " has associated a photon with pT= " << safeAccess(RECOPFPHOT_PT)[iLp[p]] <<  endl;
	    flagFSR=1;
	    pfsr=p;
	  }
	}
	if (flagFSR==1){
	  sprintf (leptformat,"FormatLept=%d:%d:%d:%d:%.2f:%.2f:%.2f:%.2f:%.2f:%.2f:%.2f:%.2f:%.3f:%.3f:%.2f:%.2f:%.2f",
		   ...
		   int(-13*safeAccess(RECOMU_CHARGE)[ipt[i]]),
		   safeAccess(RECOMU_PT)[ipt[i]],safeAccess(RECOMU_ETA)[ipt[i]],safeAccess(RECOMU_PHI)[ipt[i]],safeAccess(RECOMU_SIP)[ipt[i]],
		   safeAccess(RECOMU_PFchHad)[ipt[i]],safeAccess(RECOMU_PFneuHad)[ipt[i]],safeAccess(RECOMU_PFphoton)[ipt[i]],safeAccess(RECOMU_PFPUchAllPart)[ipt[i]],safeAccess(RECOMU_PFX_dB)[ipt[i]],dummy,
		   safeAccess(RECOPFPHOT_PT)[iLp[pfsr]],RECOPFPHOT_DR[iLp[pfsr]],safeAccess(RECOPFPHOT_PFX_rho)[iLp[pfsr]]
		   );
	}
	else {
	...
	output_txt  << leptformat << endl;
       ...
       if( i == 0){
	 hPtLep1_5->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep1_5->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep1_5->Fill( safeAccess(RECOMU_PFX_dB)[ ipt[i] ],newweight ) ;
	 hSipLep1_5->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep1_5->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep1_5->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
       if( i == 1){
	 hPtLep2_5->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep2_5->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep2_5->Fill( safeAccess(RECOMU_PFX_dB)[ ipt[i] ],newweight ) ;
	 hSipLep2_5->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep2_5->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep2_5->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
       if( i == 2){
	 hPtLep3_5->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep3_5->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep3_5->Fill( safeAccess(RECOMU_PFX_dB)[ ipt[i] ],newweight ) ;
	 hSipLep3_5->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep3_5->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep3_5->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
       if( i == 3){
	 hPtLep4_5->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep4_5->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep4_5->Fill( safeAccess(RECOMU_PFX_dB)[ ipt[i] ],newweight ) ;
	 hSipLep4_5->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep4_5->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep4_5->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
	...
	for( int p = 0; p < Nphotons; ++p ){
	  ...
	  if( iLp_l[ p ] == iL[i] && iLp_tagEM[ p ] == 0 )  {
	    cout << "Muon with pT= " << safeAccess(RECOMU_PT)[iL[i]] << " has associated a photon with pT= " << safeAccess(RECOPFPHOT_PT)[iLp[p]] <<  endl;
	    // RECOMU_PFX_dB_new[iL[i]]=
	    //   (safeAccess(RECOMU_PFchHad)[iL[i]]+
	    //    max(0.,safeAccess(RECOMU_PFneuHad)[iL[i]]+
	    // 	   (safeAccess(RECOMU_PFphoton)[iL[i]]-safeAccess(RECOPFPHOT_PT)[iLp[p]] )-
	    // 	   0.5*safeAccess(RECOMU_PFPUchAllPart)[iL[i]]))/safeAccess(RECOMU_PT)[iL[i]];
	...
	if (flagFSR==1){
	  cout << "Before correcting for FSR; muon pT= " << safeAccess(RECOMU_PT)[iL[i]] << " Eta= " << safeAccess(RECOMU_ETA)[iL[i]] << " Phi= " << safeAccess(RECOMU_PHI)[iL[i]] << endl;
	  TLorentzVector Lept,LeptCorrection;
	  Lept.SetPtEtaPhiM(safeAccess(RECOMU_PT)[iL[i]], safeAccess(RECOMU_ETA)[iL[i]], safeAccess(RECOMU_PHI)[iL[i]], 0.105);
	  LeptCorrection.SetPtEtaPhiM(safeAccess(RECOPFPHOT_PT)[iLp[pfsr]],safeAccess(RECOPFPHOT_ETA)[iLp[pfsr]],safeAccess(RECOPFPHOT_PHI)[iLp[pfsr]],0);
	  Lept+=LeptCorrection;
	  safeAccess(RECOMU_PT)[iL[i]]=Lept.Pt();
	  safeAccess(RECOMU_ETA)[iL[i]]=Lept.Eta();
	  safeAccess(RECOMU_PHI)[iL[i]]=Lept.Phi();
	  cout << "After correcting for FSR; muon pT= " << safeAccess(RECOMU_PT)[iL[i]] << " Eta= " << safeAccess(RECOMU_ETA)[iL[i]] << " Phi= " << safeAccess(RECOMU_PHI)[iL[i]] << endl;
	}
      }
      ...
      cout << "PTs= " << safeAccess(RECOMU_PT)[indexleptonfinalcorr[0]] << " " << safeAccess(RECOMU_PT)[indexleptonfinalcorr[1]] << " " <<  safeAccess(RECOMU_PT)[indexleptonfinalcorr[2]] << " " << safeAccess(RECOMU_PT)[indexleptonfinalcorr[3]]<< endl;

      for(int i = 0; i < 4; ++i) tmp_ptcorr[i] =  safeAccess(RECOMU_PT)[indexleptonfinalcorr[i]];
      for(int i = 0; i < 4; ++i){
      ...
      if(debug)
      	  for(int i = 0; i < 4; ++i)
      	  	cout << "\n iptcorr[" << i << "] = " << iptcorr[i] << "\t pt = " << safeAccess(RECOMU_PT)[ iptcorr[i] ] << endl; 
	...
	TLorentzVector tlv; tlv.SetPtEtaPhiM(safeAccess(RECOMU_PT)[indexleptonfinal[i]], safeAccess(RECOMU_ETA)[indexleptonfinal[i]], safeAccess(RECOMU_PHI)[indexleptonfinal[i]], safeAccess(RECOMU_MASS)[indexleptonfinal[i]]); 
	vtlv.push_back(tlv);
	double pterr = (safeAccess(RECOMU_muInnertrkPTError)[indexleptonfinal[i]]);
	vpterr.push_back(pterr);

	Double_t Pt = safeAccess(RECOMU_PT)[indexleptonfinal[i]]; 
        Double_t Eta = safeAccess(RECOMU_ETA)[indexleptonfinal[i]]; 
        int PDGID = 13;
	double corr=1.;
	...
	if(fabs(PDGID) == 13){    
 	  if( MC_type == "Fall11" && DATA_type == "NO"){
 	    ...
 	    vpterrcorr.push_back(double(safeAccess(RECOMU_muInnertrkPTError)[indexleptonfinal[i]]*corr));	    
 	  }
	    ...
	    vpterrcorr.push_back(double(safeAccess(RECOMU_muInnertrkPTError)[indexleptonfinal[i]]));
	  }
...
//       // if has_FSR_Z1 sumErr=safeAccess(RECOPFPHOT_PTError)[iphot]**2+safeAccess(RECOPFPHOT_PTError)[iphot]**2
//       for(int i = 0; i < 4; ++i){
//         Double_t Pt = safeAccess(RECOMU_PT)[ iL_4L[i] ]; 
//         Double_t Eta = safeAccess(RECOMU_ETA)[ iL_4L[i] ]; 
//         int PDGID = 13;
...
// 	    Int_t binx = ebe_mu_mc42x->GetXaxis()->FindBin(Pt);
// 	    Int_t biny = ebe_mu_mc42x->GetYaxis()->FindBin(Eta);
// 	    sumErr+=pow( double(safeAccess(RECOMU_muInnertrkPTError)[iL_4L[i]] * ebe_mu_mc42x->GetBinContent(binx,biny)),2.); 
// 	    vpterrcorr.push_back(double(safeAccess(RECOMU_muInnertrkPTError)[iL_4L[i]]* ebe_mu_mc42x->GetBinContent(binx,biny)));
// 	  }
// 	  else if( MC_type == "Summer12" && DATA_type == "NO"){
// 	    Int_t binx = ebe_mu_mc53x->GetXaxis()->FindBin(Pt);
// 	    Int_t biny = ebe_mu_mc53x->GetYaxis()->FindBin(Eta);
// 	    sumErr+=pow (double(safeAccess(RECOMU_muInnertrkPTError)[ iL_4L[i]] * ebe_mu_mc53x->GetBinContent(binx,biny)),2.);
// 	    vpterrcorr.push_back(double(safeAccess(RECOMU_muInnertrkPTError)[iL_4L[i]] * ebe_mu_mc53x->GetBinContent(binx,biny)));
// 	  }
// 	  else if( MC_type == "NO" && DATA_type == "2011"){
// 	    Int_t binx = ebe_mu_reco42x->GetXaxis()->FindBin(Pt);
// 	    Int_t biny = ebe_mu_reco42x->GetYaxis()->FindBin(Eta);
// 	    sumErr+=pow(double(safeAccess(RECOMU_muInnertrkPTError)[ iL_4L[i] ] * ebe_mu_reco42x->GetBinContent(binx,biny)),2.);
// 	    vpterrcorr.push_back(double(safeAccess(RECOMU_muInnertrkPTError)[iL_4L[i]] * ebe_mu_reco42x->GetBinContent(binx,biny)));
// 	  }
// 	  else if( MC_type == "NO" && DATA_type == "2012"){
// 	    Int_t binx = ebe_mu_reco53x->GetXaxis()->FindBin(Pt);
// 	    Int_t biny = ebe_mu_reco53x->GetYaxis()->FindBin(Eta);
// 	    sumErr+=pow(double(safeAccess(RECOMU_muInnertrkPTError)[ iL_4L[i] ] * ebe_mu_reco53x->GetBinContent(binx,biny)),2.);
// 	    vpterrcorr.push_back(double(safeAccess(RECOMU_muInnertrkPTError)[iL_4L[i]] * ebe_mu_reco53x->GetBinContent(binx,biny)));
// 	  }
...
//       }
	...
	for(int i = 0; i < 4; ++i){
	  ...
	  double deltaR=1000;
	  int nearest=-1;
        //Old loop: imc from 3 to 6 (i.e. daughters of daughters of ZZ candidate)
        //Fix me
	  ...
	  for (int il=0; il<2;++il) { //Loop over z boson daughters 
	    ...
	    //			     (safeAccess(RECOMU_PHI)[ ipt[i]]-safeAccess(MC_PHI)[imc]) * (safeAccess(RECOMU_PHI)[ ipt[i]]-safeAccess(MC_PHI)[imc]));
	    double d;
            if (isSignal || isggH || isvbf) {
              //These branches are bugged, so expect weird results
              if (abs(safeAccess(MC_PDGID)[imc])!=13) continue;
              d= sqrt( (safeAccess(RECOMU_ETA)[ipt[i]]-safeAccess(MC_ETA)[imc]) * (safeAccess(RECOMU_ETA)[ ipt[i]]-safeAccess(MC_ETA)[imc]) +
                             (safeAccess(RECOMU_PHI)[ ipt[i]]-safeAccess(MC_PHI)[imc]) * (safeAccess(RECOMU_PHI)[ ipt[i]]-safeAccess(MC_PHI)[imc]));
            }
	...
	hM4lres_7->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	hM4lres_vs_largeta_7->Fill(safeAccess(MC_ETA)[ilargesteta],mass4l-safeAccess(MC_MASS)[0],newweight );
	hM4lresProfEta_7->Fill(fabs(safeAccess(MC_ETA)[ilargesteta]),mass4l-safeAccess(MC_MASS)[0],newweight );

	float tmprecoeta=-999.;
	int ilargestrecoeta=-1;
	
	for (int i=0;i<4;i++){
	  if( fabs(safeAccess(RECOMU_ETA)[indexleptonfinal[i]])> tmprecoeta){
            tmprecoeta=fabs(safeAccess(RECOMU_ETA)[indexleptonfinal[i]]);
            ilargestrecoeta=indexleptonfinal[i];
          }
	}
	hrecomu_largeta->Fill((safeAccess(RECOMU_ETA)[ilargestrecoeta]),newweight);
	hrecomu_pt_largeta->Fill(safeAccess(RECOMU_PT)[ilargestrecoeta],newweight);
	hrecomu_p_largeta->Fill(safeAccess(RECOMU_PT)[ilargestrecoeta]/sin(safeAccess(RECOMU_THETA)[ilargestrecoeta]),newweight);

	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0. && safeAccess(RECOMU_ETA)[ilargestrecoeta]<0.3) {
	  hM4lres_7_bin1->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin1->Fill(pT4l,newweight );	    
	  hpT1res_7_bin1->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin1->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin1->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin1->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	    
	}
	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0.3 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<0.6) {
	  hM4lres_7_bin2->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin2->Fill(pT4l,newweight );
	  hpT1res_7_bin2->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin2->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin2->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin2->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	 
	}
	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0.6 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<0.9) {
	  hM4lres_7_bin3->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin3->Fill(pT4l,newweight );	
	  hpT1res_7_bin3->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin3->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin3->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin3->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	 
	}
	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0.9 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.2) {
	  hM4lres_7_bin4->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin4->Fill(pT4l,newweight );	
	  hpT1res_7_bin4->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin4->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin4->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin4->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	 
	}
	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.2 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.5) {
	  hM4lres_7_bin5->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin5->Fill(pT4l,newweight );
	  hpT1res_7_bin5->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin5->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin5->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin5->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	 
	}
	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.5 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.8) {
	  hM4lres_7_bin6->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin6->Fill(pT4l,newweight );
	  hpT1res_7_bin6->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin6->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin6->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin6->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	 
	}
	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.8 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.1) {
	  hM4lres_7_bin7->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin7->Fill(pT4l,newweight );
	  hpT1res_7_bin7->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin7->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin7->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin7->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	 
	}
	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.1 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.4) {
	  hM4lres_7_bin8->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin8->Fill(pT4l,newweight );
	  hpT1res_7_bin8->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin8->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin8->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin8->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	 
	}
	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.4 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.7) {
	  hM4lres_7_bin9->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin9->Fill(pT4l,newweight );
	  hpT1res_7_bin9->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin9->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin9->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin9->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	 
	}
	if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.7 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<3.0) {
	  hM4lres_7_bin10->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
	  hpT4lres_7_bin10->Fill(pT4l,newweight );
	  hpT1res_7_bin10->Fill(safeAccess(RECOMU_PT)[ipt[0]],newweight);
	  hpT2res_7_bin10->Fill(safeAccess(RECOMU_PT)[ipt[1]],newweight);
	  hpT3res_7_bin10->Fill(safeAccess(RECOMU_PT)[ipt[2]],newweight);	   
	  hpT4res_7_bin10->Fill(safeAccess(RECOMU_PT)[ipt[3]],newweight);	 
	}


        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0. && safeAccess(RECOMU_ETA)[ilargestrecoeta]<0.5)   hM4lresol_7_bin1->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0.5 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.0)  hM4lresol_7_bin2->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.0 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.5)  hM4lresol_7_bin3->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.5 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.0)  hM4lresol_7_bin4->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.0 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.4)  hM4lresol_7_bin5->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.4 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<=2.8)  hM4lresol_7_bin6->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );


        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0. && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.0)   hM4lresolut_7_bin1->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.0 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.0)  hM4lresolut_7_bin2->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.0 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.4)  hM4lresolut_7_bin3->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.4 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<=2.8)  hM4lresolut_7_bin4->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );


        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0. && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.2)   hM4lresolution_7_bin1->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.2 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.4)  hM4lresolution_7_bin2->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );
        if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.4 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<=2.8)  hM4lresolution_7_bin3->Fill(mass4l-safeAccess(MC_MASS)[0],newweight );


	if (datasetName.Contains("ZZTo4L_13TeV_powheg_pythia8")){
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0. && safeAccess(RECOMU_ETA)[ilargestrecoeta]<0.3 && mass4l>=70. && mass4l<=110. ) hM4lZres_7_bin1->Fill(mass4l-Zmass,newweight );
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0.3 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<0.6 && mass4l>=70. && mass4l<=110.) hM4lZres_7_bin2->Fill(mass4l-Zmass,newweight );
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0.6 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<0.9 && mass4l>=70. && mass4l<=110.) hM4lZres_7_bin3->Fill(mass4l-Zmass,newweight );
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=0.9 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.2 && mass4l>=70. && mass4l<=110.) hM4lZres_7_bin4->Fill(mass4l-Zmass,newweight );
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.2 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.5 && mass4l>=70. && mass4l<=110.) hM4lZres_7_bin5->Fill(mass4l-Zmass,newweight );
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.5 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<1.8 && mass4l>=70. && mass4l<=110.) hM4lZres_7_bin6->Fill(mass4l-Zmass,newweight );
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=1.8 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.1 && mass4l>=70. && mass4l<=110.) hM4lZres_7_bin7->Fill(mass4l-Zmass,newweight );
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.1 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.4 && mass4l>=70. && mass4l<=110.) hM4lZres_7_bin8->Fill(mass4l-Zmass,newweight );
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.4 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<2.7 && mass4l>=70. && mass4l<=110.) hM4lZres_7_bin9->Fill(mass4l-Zmass,newweight );
	  if (safeAccess(RECOMU_ETA)[ilargestrecoeta]>=2.7 && safeAccess(RECOMU_ETA)[ilargestrecoeta]<3.0 && mass4l>=70. && mass4l<=110.) hM4lZres_7_bin10->Fill(mass4l-Zmass,newweight );	
	}
     ...
     hPFMET_7_nofilter->Fill(RECO_PFMET,newweight);
     if (pass_METFilters) hPFMET_7->Fill(RECO_PFMET,newweight);
     ...
     for(int i = 0; i < 4; ++i){
       ...
       if( i == 0){
	 hPtLep1_7->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep1_7->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep1_7->Fill( RECOMU_PFX_dB_new[ ipt[i] ],newweight ) ;
	 hSipLep1_7->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep1_7->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep1_7->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
       if( i == 1){
	 hPtLep2_7->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep2_7->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep2_7->Fill( RECOMU_PFX_dB_new[ ipt[i] ],newweight ) ;
	 hSipLep2_7->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep2_7->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep2_7->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
       if( i == 2){
	 hPtLep3_7->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep3_7->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep3_7->Fill( RECOMU_PFX_dB_new[ ipt[i] ],newweight ) ;
	 hSipLep3_7->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep3_7->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep3_7->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
       if( i == 3){
	 hPtLep4_7->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep4_7->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep4_7->Fill( RECOMU_PFX_dB_new[ ipt[i] ],newweight ) ;
	 hSipLep4_7->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep4_7->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep4_7->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
     ...
     output_txt << "EVENT_7:"<< Run<< ":" << LumiSection<< ":" << Event	<< ":" << mass4l<< ":" << massZ1<< ":" << massZ2 << ":" <<f_D_bkg_kin<< ":" <<safeAccess(RECOMU_PT)[ ipt[0] ]<< ":" <<safeAccess(RECOMU_PT)[ ipt[1] ]<< ":" <<safeAccess(RECOMU_PT)[ ipt[2] ]<< ":" <<safeAccess(RECOMU_PT)[ ipt[3] ]<< ":" <<safeAccess(RECOMU_ETA)[ ipt[0] ]<< ":" <<safeAccess(RECOMU_ETA)[ ipt[1] ]<< ":" <<safeAccess(RECOMU_ETA)[ ipt[2] ]<< ":" <<safeAccess(RECOMU_ETA)[ ipt[3] ]<< ":" <<safeAccess(RECOMU_PHI)[ ipt[0] ]<< ":" <<safeAccess(RECOMU_PHI)[ ipt[1] ]<< ":" <<safeAccess(RECOMU_PHI)[ ipt[2] ]<< ":" <<safeAccess(RECOMU_PHI)[ ipt[3] ]<<endl;     
     ...
     for(int i = 0; i < 4; ++i){
       ...
       if( i == 0){
	 hPtLep1_8->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep1_8->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep1_8->Fill( RECOMU_PFX_dB_new[ ipt[i] ],newweight ) ;
	 hSipLep1_8->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep1_8->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep1_8->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
       if( i == 1){
	 hPtLep2_8->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep2_8->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep2_8->Fill( RECOMU_PFX_dB_new[ ipt[i] ],newweight ) ;
	 hSipLep2_8->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep2_8->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep2_8->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
       if( i == 2){
	 hPtLep3_8->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep3_8->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep3_8->Fill( RECOMU_PFX_dB_new[ ipt[i] ],newweight ) ;
	 hSipLep3_8->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep3_8->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep3_8->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
       if( i == 3){
	 hPtLep4_8->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 hYLep4_8->Fill(  safeAccess(RECOMU_ETA)[ ipt[i] ],newweight ) ;
	 hIsoLep4_8->Fill( RECOMU_PFX_dB_new[ ipt[i] ],newweight ) ;
	 hSipLep4_8->Fill( safeAccess(RECOMU_SIP)[ ipt[i] ],newweight ) ;
	 hIpLep4_8->Fill( safeAccess(RECOMU_IP)[ ipt[i] ],newweight ) ;
	 hIpErLep4_8->Fill( safeAccess(RECOMU_IPERROR)[ ipt[i] ],newweight ) ;
       }
     ...
     hPFMET_8_nofilter->Fill(RECO_PFMET,newweight);  
     if (pass_METFilters) {hPFMET_8->Fill(RECO_PFMET,newweight);
     ...
     for(int i=0;i<RECO_PFJET_N;i++){
       cout<<i<<" Jet with pt= "<<safeAccess(RECO_PFJET_PT)[i]<<" ETA "<<safeAccess(RECO_PFJET_ETA)[i]<<" PUID "<<safeAccess(RECO_PFJET_PUID)[i] << " PUID_MVA "<< safeAccess(RECO_PFJET_PUID_MVA)[i]<<endl;
	 ...
	 JME::JetParameters sf_parameters = {{JME::Binning::JetEta, safeAccess(RECO_PFJET_ETA)[i]}, {JME::Binning::Rho, RHO_mu}};
	 ...
	 float factordn = jetresolution_sf.getScaleFactor(sf_parameters, Variation::DOWN);
       ...
       //jet_jer_tmp.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[i],safeAccess(RECO_PFJET_ETA)[i],safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECO_PFJET_ET)[i]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[i]));
       //jet_jer.SetPxPyPzE(jercorr*jet_jer_tmp.Px(),jercorr*jet_jer_tmp.Py(),jercorr*jet_jer_tmp.Pz(),jercorr*jet_jer_tmp.E());
       //safeAccess(RECO_PFJET_PT)[i]=jet_jer.Perp(); // pt jet corrected
       //safeAccess(RECO_PFJET_ETA)[i]=jet_jer.Eta();
       //safeAccess(RECO_PFJET_PHI)[i]=jet_jer.Phi();
       //safeAccess(RECO_PFJET_ET)[i]=jet_jer.Et();

       //if(safeAccess(RECO_PFJET_PUID)[i]==1 && safeAccess(RECO_PFJET_PT)[i]>30. && fabs(safeAccess(RECO_PFJET_ETA)[i])<4.7 ){ // NO PU ID temporary
       if(safeAccess(RECO_PFJET_PT)[i]>30. && fabs(safeAccess(RECO_PFJET_ETA)[i])<4.7 ){
       
      	 //Check that jet has deltaR>0.4 away from any tight lepton corrected for FSR
	 for(int mu = 0; mu < N_good; ++mu){
	   if (fabs(safeAccess(RECOMU_SIP)[iL[mu]])>=4.) continue;
      	   if (RECOMU_PFX_dB_new[iL[mu]]>=0.35) continue;
	   double deltaR = sqrt( pow(DELTAPHI(safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECOMU_PHI)[iL[mu]]),2) + pow(safeAccess(RECO_PFJET_ETA)[i] - safeAccess(RECOMU_ETA)[iL[mu]],2));
	   cout << "1st lepton muon: " << " pT=" << safeAccess(RECOMU_PT)[iL[mu]] <<" deltaR "<< deltaR <<endl;	   
	   if (deltaR<0.4){
	     jetfail[i]=1;
	     ...
	     break;
      	 ...
      	 for(int ele = 0; ele < Ne_good; ++ele){
      	   if (fabs(safeAccess(RECOELE_SIP)[iLe[ele]])>=4.) continue;
	   if (RECOELE_PFX_rho_new[iLe[ele]]>=0.35) continue;
      	   double deltaR = sqrt( pow(DELTAPHI(safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECOELE_PHI)[iLe[ele]]),2) + pow(safeAccess(RECO_PFJET_ETA)[i] - safeAccess(RECOELE_ETA)[iLe[ele]],2));
     	   cout << "1st lepton electron: " << " pT=" << safeAccess(RECOELE_PT)[iLe[ele]] <<" deltaR "<< deltaR <<endl;
	   if (deltaR<0.4){
     	     jetfail[i]=1;
     	     cout << " jetfail " << jetfail[i] <<endl;
	     break;
	 ...
	 for(int j=0.;j<Nphotons;j++) {
	     ...
	     if (iLp_tagEM[j]==0) cout << "There is photon with pT= " << safeAccess(RECOPFPHOT_PT)[iLp[j]] << " attached to a muon with pT= " << safeAccess(RECOMU_PT)[iLp_l[j]] << endl;
	     if (iLp_tagEM[j]==1) cout << "There is photon with pT= " << safeAccess(RECOPFPHOT_PT)[iLp[j]] << " attached to a electron with pT= " << safeAccess(RECOELE_PT)[iLp_l[j]] << endl;
	     double deltaR = sqrt( pow(DELTAPHI(safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECOPFPHOT_PHI)[iLp[j]]),2) + pow(safeAccess(RECO_PFJET_ETA)[i] - safeAccess(RECOPFPHOT_ETA)[iLp[j]],2));
	     if (deltaR<0.4){
	       jetfail[i]=1;
	       cout << " jetfail " << jetfail[i] <<endl;
	       break;
	 ...
	 if (jetfail[i]==0){
	   ...
	   if (njets_pass==1){
	     jet1=i;
	     JET1.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[i],safeAccess(RECO_PFJET_ETA)[i],safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECO_PFJET_ET)[i]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[i]));

	     f_jet1_highpt_pt = safeAccess(RECO_PFJET_PT)[i];
	     f_jet1_highpt_eta = safeAccess(RECO_PFJET_ETA)[i];
	     f_jet1_highpt_phi = safeAccess(RECO_PFJET_PHI)[i];
	     f_jet1_highpt_e = safeAccess(RECO_PFJET_ET)[i];
	   }
	   if (njets_pass==2){
	     jet2=i;
	     JET2.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[i],safeAccess(RECO_PFJET_ETA)[i],safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECO_PFJET_ET)[i]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[i]));

	     f_jet2_highpt_pt = safeAccess(RECO_PFJET_PT)[i];
	     f_jet2_highpt_eta = safeAccess(RECO_PFJET_ETA)[i];
	     f_jet2_highpt_phi = safeAccess(RECO_PFJET_PHI)[i];
	     f_jet2_highpt_e = safeAccess(RECO_PFJET_ET)[i];
	   }
	   if (njets_pass==3){
	     f_jet3_highpt_pt = safeAccess(RECO_PFJET_PT)[i];
	     f_jet3_highpt_eta = safeAccess(RECO_PFJET_ETA)[i];
	     f_jet3_highpt_phi = safeAccess(RECO_PFJET_PHI)[i];
	     f_jet3_highpt_e = safeAccess(RECO_PFJET_ET)[i];
	   }

	   //@ fills all jets
	  if(njets_pass <= maxJets){
            f_jets_highpt_pt[njets_pass-1]                           = safeAccess(RECO_PFJET_PT)[i];
	    f_jets_highpt_pt_error[njets_pass-1]                     = safeAccess(RECO_PFJET_PT)[i]-safeAccess(RECO_PFJET_PT_UncDn)[i];//The error is symmetric
            f_jets_highpt_eta[njets_pass-1]                          = safeAccess(RECO_PFJET_ETA)[i];
            f_jets_highpt_phi[njets_pass-1]                          = safeAccess(RECO_PFJET_PHI)[i];
            f_jets_highpt_et[njets_pass-1]                           = safeAccess(RECO_PFJET_ET)[i];
            f_jets_highpt_area[njets_pass-1]                         = safeAccess(RECO_PFJET_AREA)[i];
            f_jets_highpt_charged_hadron_multiplicity[njets_pass-1]  = safeAccess(RECO_PFJET_CHARGED_HADRON_MULTIPLICITY)[i];
            f_jets_highpt_charged_multiplicity[njets_pass-1]         = safeAccess(RECO_PFJET_CHARGED_MULTIPLICITY)[i];
            f_jets_highpt_electron_multiplicity[njets_pass-1]        = safeAccess(RECO_PFJET_ELECTRON_MULTIPLICITY)[i];
            f_jets_highpt_hf_em_multiplicity[njets_pass-1]           = safeAccess(RECO_PFJET_HF_EM_MULTIPLICITY)[i];
            f_jets_highpt_hf_hadron_multiplicity[njets_pass-1]       = safeAccess(RECO_PFJET_HF_HADRON_MULTIPLICTY)[i];
            f_jets_highpt_muon_multiplicity[njets_pass-1]            = safeAccess(RECO_PFJET_MUON_MULTIPLICITY)[i];
            f_jets_highpt_neutral_hadron_multiplicity[njets_pass-1]  = safeAccess(RECO_PFJET_NEUTRAL_HADRON_MULTIPLICITY)[i];
            f_jets_highpt_neutral_multiplicity[njets_pass-1]         = safeAccess(RECO_PFJET_NEUTRAL_MULTIPLICITY)[i];
            f_jets_highpt_photon_multiplicity[njets_pass-1]          = safeAccess(RECO_PFJET_PHOTON_MULTIPLICITY)[i];
            f_jets_highpt_charged_hadron_energy[njets_pass-1]        = safeAccess(RECO_PFJET_CHARGED_HADRON_ENERGY)[i];
            f_jets_highpt_neutral_hadron_energy[njets_pass-1]        = safeAccess(RECO_PFJET_NEUTRAL_HADRON_ENERGY)[i];
            f_jets_highpt_photon_energy[njets_pass-1]                = safeAccess(RECO_PFJET_PHOTON_ENERGY)[i];
            f_jets_highpt_electron_energy[njets_pass-1]              = safeAccess(RECO_PFJET_ELECTRON_ENERGY)[i];
            f_jets_highpt_muon_energy[njets_pass-1]                  = safeAccess(RECO_PFJET_MUON_ENERGY)[i];
            f_jets_highpt_hf_hadron_energy[njets_pass-1]             = safeAccess(RECO_PFJET_HF_HADRON_ENERGY)[i];
            f_jets_highpt_hf_em_energy[njets_pass-1]                 = safeAccess(RECO_PFJET_HF_EM_ENERGY)[i];
            f_jets_highpt_charged_em_energy[njets_pass-1]            = safeAccess(RECO_PFJET_CHARGED_EM_ENERGY)[i];
            f_jets_highpt_charged_mu_energy[njets_pass-1]            = safeAccess(RECO_PFJET_CHARGED_MU_ENERGY)[i];
            f_jets_highpt_neutral_em_energy[njets_pass-1]            = safeAccess(RECO_PFJET_NEUTRAL_EM_ENERGY)[i];
            f_jets_highpt_ptd[njets_pass-1]                          = safeAccess(RECO_PFJET_PTD)[i];
            f_jets_highpt_ncomponents[njets_pass-1]                  = safeAccess(RECO_PFJET_NCOMPONENTS)[i];
            for(int ic=0; ic<maxJetsComponents; ++ic){
              f_jets_highpt_component_pdgid[njets_pass-1][ic]        = safeAccess(RECO_PFJET_COMPONENT_PDGID)[i][ic];
              f_jets_highpt_component_pt[njets_pass-1][ic]           = safeAccess(RECO_PFJET_COMPONENT_PT)[i][ic];
              f_jets_highpt_component_eta[njets_pass-1][ic]          = safeAccess(RECO_PFJET_COMPONENT_ETA)[i][ic];
              f_jets_highpt_component_phi[njets_pass-1][ic]          = safeAccess(RECO_PFJET_COMPONENT_PHI)[i][ic];
              f_jets_highpt_component_energy[njets_pass-1][ic]       = safeAccess(RECO_PFJET_COMPONENT_E)[i][ic];
              f_jets_highpt_component_charge[njets_pass-1][ic]       = safeAccess(RECO_PFJET_COMPONENT_CHARGE)[i][ic];
              f_jets_highpt_component_mt[njets_pass-1][ic]           = safeAccess(RECO_PFJET_COMPONENT_TRANSVERSE_MASS)[i][ic];
              f_jets_highpt_component_xvertex[njets_pass-1][ic]      = safeAccess(RECO_PFJET_COMPONENT_XVERTEX)[i][ic];
              f_jets_highpt_component_yvertex[njets_pass-1][ic]      = safeAccess(RECO_PFJET_COMPONENT_YVERTEX)[i][ic];
              f_jets_highpt_component_zvertex[njets_pass-1][ic]      = safeAccess(RECO_PFJET_COMPONENT_ZVERTEX)[i][ic];
              f_jets_highpt_component_vertex_chi2[njets_pass-1][ic]  = safeAccess(RECO_PFJET_COMPONENT_VERTEX_CHI2)[i][ic];
            }
          }
     ...
     int n_bjets_loose =0;
     int n_bjets_medium =0;
     int n_bjets_tight =0;

     //check loose & medium & tight discrimentors

     for (int i=0;i<50;i++){
       if (safeAccess(cSV_BTagJet_DISCR)[i] > 0.1522){ // Loose
	 if(safeAccess(cSV_BTagJet_PT)[i]>30. && fabs(safeAccess(cSV_BTagJet_ETA)[i])<4.7 ) cout << "Found a loose bjet (pT>30 and |eta|<2.4) with pT= " << safeAccess(cSV_BTagJet_PT)[i] << endl;	 
	 n_bjets_loose++;   
       }

       if (safeAccess(cSV_BTagJet_DISCR)[i] > 0.4941){ // medium
	 if(safeAccess(cSV_BTagJet_PT)[i]>30. && fabs(safeAccess(cSV_BTagJet_ETA)[i])<4.7 ) cout << "Found a medium bjet (pT>30 and |eta|<2.4) with pT= " << safeAccess(cSV_BTagJet_PT)[i] << endl;	 
	 n_bjets_medium++;   
       }

       if (safeAccess(cSV_BTagJet_DISCR)[i] > 0.8001){ // tight
	 if(safeAccess(cSV_BTagJet_PT)[i]>30. && fabs(safeAccess(cSV_BTagJet_ETA)[i])<4.7 ) cout << "Found a tight bjet (pT>30 and |eta|<2.4) with pT= " << safeAccess(cSV_BTagJet_PT)[i] << endl;	 
	 n_bjets_tight++;   
       }
     }

     hN_bjets_loose->Fill(n_bjets_loose,newweight);
     hN_bjets_medium->Fill(n_bjets_medium,newweight);
     hN_bjets_tight->Fill(n_bjets_tight,newweight);
     
     for (int i=0;i<50;i++){
       //if (safeAccess(cSV_BTagJet_DISCR)[i] > 0.1522){ // Loose
       if (safeAccess(cSV_BTagJet_DISCR)[i] > 0.4941){ // Medium
	 if(safeAccess(cSV_BTagJet_PT)[i]>30. && fabs(safeAccess(cSV_BTagJet_ETA)[i])<4.7 ) cout << "Found a bjet (pT>30 and |eta|<2.4) with pT= " << safeAccess(cSV_BTagJet_PT)[i] << endl;	 
	 n_bjets++;
	 ...
	 JET1_VBF.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[i],safeAccess(RECO_PFJET_ETA)[i],safeAccess(RECO_PFJET_PHI)[i],safeAccess(RECO_PFJET_ET)[i]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[i]));
	 JET2_VBF.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[j],safeAccess(RECO_PFJET_ETA)[j],safeAccess(RECO_PFJET_PHI)[j],safeAccess(RECO_PFJET_ET)[j]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[j]));
     ...
     for(int i=0;i<RECO_PFJET_N;i++){
       if (jetfail[i]!=0) continue;
       for (int j=0;j<50;j++){
	 if (safeAccess(cSV_BTagJet_PT)[j]==safeAccess(RECO_PFJET_PT)[i] && safeAccess(cSV_BTagJet_DISCR)[j]>0.4941 && safeAccess(cSV_BTagJet_PT)[j]>30. && fabs(safeAccess(cSV_BTagJet_ETA)[j])<4.7) {
	   //if (safeAccess(cSV_BTagJet_PT)[j]==safeAccess(RECO_PFJET_PT)[i] && safeAccess(cSV_BTagJet_DISCR)[j]>0.460 && safeAccess(cSV_BTagJet_PT)[j]>30. && fabs(safeAccess(cSV_BTagJet_ETA)[j])<4.7) {
	   //if (safeAccess(cSV_BTagJet_DISCR)[j]>0.8484 && safeAccess(cSV_BTagJet_PT)[j]>30. && fabs(safeAccess(cSV_BTagJet_ETA)[j])<4.7) {
	   n_match_bjets++;
     ...
     for(int j=0;j<RECO_PFJET_N;j++){
        if (jetfail[j]!=0) continue;
	 cout << "ptjet= " << safeAccess(RECO_PFJET_PT)[j] << " eta= " << fabs(safeAccess(RECO_PFJET_ETA)[j]) << endl;
        if(safeAccess(RECO_PFJET_PT)[j]>40. && fabs(safeAccess(RECO_PFJET_ETA)[j])<2.4){
	 cout << "Possible jet for VH categories with pT= " << safeAccess(RECO_PFJET_PT)[j] << endl;
	 for (int k=j+1;k<RECO_PFJET_N; k++){
	   if (jetfail[k]!=0) continue;
	   cout << "Possible jet for VH categories with pT= " << safeAccess(RECO_PFJET_PT)[k] << endl;
	   if(safeAccess(RECO_PFJET_PT)[k]>40. && fabs(safeAccess(RECO_PFJET_ETA)[k])<2.4){	     
	     JET1_VH.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[j],safeAccess(RECO_PFJET_ETA)[j],safeAccess(RECO_PFJET_PHI)[j],safeAccess(RECO_PFJET_ET)[j]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[j]));
	     JET2_VH.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[k],safeAccess(RECO_PFJET_ETA)[k],safeAccess(RECO_PFJET_PHI)[k],safeAccess(RECO_PFJET_ET)[k]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[k]));
	     mJJ_VH=JET1_VH+JET2_VH;
	     
	     if (mJJ_VH.M()>60. && mJJ_VH.M()<120.) {
	       cout << "Jets for VH categories passing, pT>40, |eta|<2.4 and 60<mjj<120 with pT= " << safeAccess(RECO_PFJET_PT)[j] << " " << safeAccess(RECO_PFJET_PT)[k] << endl;
	       n_jets_mjj_VH++ ;
     ...
     if (N_good==4 && njets_vbf>=1 && n_bjets<=1){
       ...
       JET1.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[jet1],safeAccess(RECO_PFJET_ETA)[jet1],safeAccess(RECO_PFJET_PHI)[jet1],safeAccess(RECO_PFJET_ET)[jet1]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[jet1]));
       JET2.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[jet2],safeAccess(RECO_PFJET_ETA)[jet2],safeAccess(RECO_PFJET_PHI)[jet2],safeAccess(RECO_PFJET_ET)[jet2]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[jet2]));
	 ...
	 JET1.SetPtEtaPhiE(safeAccess(cSV_BTagJet_PT)[index_bjets[0]],safeAccess(cSV_BTagJet_ETA)[index_bjets[0]],
			   safeAccess(cSV_BTagJet_PHI)[index_bjets[0]],safeAccess(cSV_BTagJet_ET)[index_bjets[0]]*TMath::CosH(safeAccess(cSV_BTagJet_ETA)[index_bjets[0]]));
	 JET2.SetPtEtaPhiE(safeAccess(cSV_BTagJet_PT)[index_bjets[1]],safeAccess(cSV_BTagJet_ETA)[index_bjets[1]],
			   safeAccess(cSV_BTagJet_PHI)[index_bjets[1]],safeAccess(cSV_BTagJet_ET)[index_bjets[1]]*TMath::CosH(safeAccess(cSV_BTagJet_ETA)[index_bjets[1]]));
     ...
     f_lept1_pt = safeAccess(RECOMU_PT)[iptcorr[0]] ;
     f_lept1_pt_error = safeAccess(RECOMU_mubesttrkPTError)[iptcorr[0]] ;
     f_lept1_eta = safeAccess(RECOMU_ETA)[iptcorr[0]] ;
     f_lept1_phi = safeAccess(RECOMU_PHI)[iptcorr[0]];
     f_lept1_charge = safeAccess(RECOMU_CHARGE)[iptcorr[0]];
     f_lept1_pfx = RECOMU_PFX_dB_new[iptcorr[0]];
     f_lept1_sip = safeAccess(RECOMU_SIP)[iptcorr[0]];
     //    f_lept1_mvaid = RECOMU_mvaNonTrigV0[iptcorr[0]];
     
     f_lept2_pt = safeAccess(RECOMU_PT)[iptcorr[1]] ;
     f_lept2_pt_error = safeAccess(RECOMU_mubesttrkPTError)[iptcorr[1]] ;
     f_lept2_eta = safeAccess(RECOMU_ETA)[iptcorr[1]] ;
     f_lept2_phi = safeAccess(RECOMU_PHI)[iptcorr[1]];
     f_lept2_charge = safeAccess(RECOMU_CHARGE)[iptcorr[1]];
     f_lept2_pfx = RECOMU_PFX_dB_new[iptcorr[1]];
     f_lept2_sip = safeAccess(RECOMU_SIP)[iptcorr[1]];
     //    f_lept2_mvaid = RECOMU_mvaNonTrigV0[iptcorr[1]];
     f_lept3_pt = safeAccess(RECOMU_PT)[iptcorr[2]] ;
     f_lept3_pt_error = safeAccess(RECOMU_mubesttrkPTError)[iptcorr[2]] ;
     f_lept3_eta = safeAccess(RECOMU_ETA)[iptcorr[2]] ;
     f_lept3_phi = safeAccess(RECOMU_PHI)[iptcorr[2]];
     f_lept3_charge = safeAccess(RECOMU_CHARGE)[iptcorr[2]];
     f_lept3_pfx = RECOMU_PFX_dB_new[iptcorr[2]];
     f_lept3_sip = safeAccess(RECOMU_SIP)[iptcorr[2]];
     //    f_lept3_mvaid = RECOMU_mvaNonTrigV0[iptcorr[2]];
     f_lept4_pt = safeAccess(RECOMU_PT)[iptcorr[3]] ;
     f_lept4_pt_error = safeAccess(RECOMU_mubesttrkPTError)[iptcorr[3]] ;
     f_lept4_eta = safeAccess(RECOMU_ETA)[iptcorr[3]] ;
     f_lept4_phi = safeAccess(RECOMU_PHI)[iptcorr[3]];
     f_lept4_charge = safeAccess(RECOMU_CHARGE)[iptcorr[3]];
     f_lept4_pfx = RECOMU_PFX_dB_new[iptcorr[3]];
     f_lept4_sip = safeAccess(RECOMU_SIP)[iptcorr[3]];
     ...
     if (njets_pass<1) {
       ...
       f_jet1_pt = safeAccess(RECO_PFJET_PT)[jet1];
       f_jet1_eta = safeAccess(RECO_PFJET_ETA)[jet1];
       f_jet1_phi = safeAccess(RECO_PFJET_PHI)[jet1];
       f_jet1_e = safeAccess(RECO_PFJET_ET)[jet1];
     }
       ...
       f_jet1_phi = safeAccess(RECO_PFJET_PHI)[jet1];
       f_jet1_e = safeAccess(RECO_PFJET_ET)[jet1];
       f_jet2_pt = safeAccess(RECO_PFJET_PT)[jet2];
       f_jet2_eta = safeAccess(RECO_PFJET_ETA)[jet2];
       f_jet2_phi = safeAccess(RECO_PFJET_PHI)[jet2];
       f_jet2_e = safeAccess(RECO_PFJET_ET)[jet2];

       TLorentzVector JET1new,JET2new,mJJnew;
       JET1new.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[jet1],safeAccess(RECO_PFJET_ETA)[jet1],safeAccess(RECO_PFJET_PHI)[jet1],safeAccess(RECO_PFJET_ET)[jet1]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[jet1]));
       JET2new.SetPtEtaPhiE(safeAccess(RECO_PFJET_PT)[jet2],safeAccess(RECO_PFJET_ETA)[jet2],safeAccess(RECO_PFJET_PHI)[jet2],safeAccess(RECO_PFJET_ET)[jet2]*TMath::CosH(safeAccess(RECO_PFJET_ETA)[jet2]));
     ...
     cout << "Final: pT of final leptons from Z1 and Z2 ="
	  << safeAccess(RECOMU_PT)[indexleptonfinal[0]] << " " << safeAccess(RECOMU_PT)[indexleptonfinal[1]] << " " << safeAccess(RECOMU_PT)[indexleptonfinal[2]] << " " << safeAccess(RECOMU_PT)[indexleptonfinal[3]] <<endl;
     
     L11P4.SetPtEtaPhiM(safeAccess(RECOMU_PT)[indexleptonfinal[0]], safeAccess(RECOMU_ETA)[indexleptonfinal[0]], safeAccess(RECOMU_PHI)[indexleptonfinal[0]], 0.105);
     L12P4.SetPtEtaPhiM(safeAccess(RECOMU_PT)[indexleptonfinal[1]], safeAccess(RECOMU_ETA)[indexleptonfinal[1]], safeAccess(RECOMU_PHI)[indexleptonfinal[1]], 0.105);
     L21P4.SetPtEtaPhiM(safeAccess(RECOMU_PT)[indexleptonfinal[2]], safeAccess(RECOMU_ETA)[indexleptonfinal[2]], safeAccess(RECOMU_PHI)[indexleptonfinal[2]], 0.105);
     L22P4.SetPtEtaPhiM(safeAccess(RECOMU_PT)[indexleptonfinal[3]], safeAccess(RECOMU_ETA)[indexleptonfinal[3]], safeAccess(RECOMU_PHI)[indexleptonfinal[3]], 0.105);
     ...
     // 	   cout << "Muon with pT= " << safeAccess(RECOMU_PT)[indexleptonfinal[i]] << " has associated a photon with pT= " << safeAccess(RECOPFPHOT_PT)[iLp[p]] <<  endl;
     // 	   flagFSR=1;
     // 	   pfsr=p;
     // 	 }
     //   }

     //   if (flagFSR==1) L1correctionP4.SetPtEtaPhiM(safeAccess(RECOPFPHOT_PT)[iLp[pfsr]],safeAccess(RECOPFPHOT_ETA)[iLp[pfsr]],safeAccess(RECOPFPHOT_PHI)[iLp[pfsr]],0);
     ...
     if (safeAccess(RECOMU_CHARGE)[indexleptonfinal[0]] == 1){
       L11PID=-13;
       L12PID=+13;
       f_lept1_pdgid=-13.;
       f_lept2_pdgid=13.;
     }
     else if (safeAccess(RECOMU_CHARGE)[indexleptonfinal[0]] == -1){
       L11PID=13;
       L12PID=-13;
       f_lept1_pdgid=13.;
       f_lept2_pdgid=-13.;
     ...
     if (safeAccess(RECOMU_CHARGE)[indexleptonfinal[2]] == 1){
       L21PID=-13;
       L22PID=13;
       f_lept3_pdgid=-13.;
       f_lept4_pdgid=13.;
     }
     else if (safeAccess(RECOMU_CHARGE)[indexleptonfinal[2]] == -1){
       L21PID=13;
       L22PID=-13;
       f_lept3_pdgid=13.;
       f_lept4_pdgid=-13.;
	 ...
	 partP.SetPtEtaPhiE(L11P4.Pt()+safeAccess(RECOMU_mubesttrkPTError)[indexleptonfinal[0]],L11P4.Eta(),L11P4.Phi(),L11P4.E());		vpartP.push_back( partP );//+ Pt Uncertainty
	 partP.SetPtEtaPhiE(L11P4.Pt()-safeAccess(RECOMU_mubesttrkPTError)[indexleptonfinal[0]],L11P4.Eta(),L11P4.Phi(),L11P4.E());		vpartP.push_back( partP );//- Pt Uncertainty
	 vpartsP.push_back( vpartP );

	 vpartP.clear();
	 partP.SetPtEtaPhiE(L12P4.Pt(),L12P4.Eta(),L12P4.Phi(),L12P4.E());							vpartP.push_back( partP );//Nominal
	 partP.SetPtEtaPhiE(L12P4.Pt()+safeAccess(RECOMU_mubesttrkPTError)[indexleptonfinal[1]],L12P4.Eta(),L12P4.Phi(),L12P4.E());		vpartP.push_back( partP );//+Pt Uncertainty
	 partP.SetPtEtaPhiE(L12P4.Pt()-safeAccess(RECOMU_mubesttrkPTError)[indexleptonfinal[1]],L12P4.Eta(),L12P4.Phi(),L12P4.E());		vpartP.push_back( partP );//-Pt Uncertainty
	 vpartsP.push_back( vpartP );

	 vpartP.clear();
	 partP.SetPtEtaPhiE(L21P4.Pt(),L21P4.Eta(),L21P4.Phi(),L21P4.E());							vpartP.push_back( partP );//Nominal
	 partP.SetPtEtaPhiE(L21P4.Pt()+safeAccess(RECOMU_mubesttrkPTError)[indexleptonfinal[2]],L21P4.Eta(),L21P4.Phi(),L21P4.E());		vpartP.push_back( partP );//+Pt Uncertainty
	 partP.SetPtEtaPhiE(L21P4.Pt()-safeAccess(RECOMU_mubesttrkPTError)[indexleptonfinal[2]],L21P4.Eta(),L21P4.Phi(),L21P4.E());		vpartP.push_back( partP );//-Pt Uncertainty
	 vpartsP.push_back( vpartP );
	 
	 vpartP.clear();
	 partP.SetPtEtaPhiE(L22P4.Pt(),L22P4.Eta(),L22P4.Phi(),L22P4.E());							vpartP.push_back( partP );//Nominal
	 partP.SetPtEtaPhiE(L22P4.Pt()+safeAccess(RECOMU_mubesttrkPTError)[indexleptonfinal[3]],L22P4.Eta(),L22P4.Phi(),L22P4.E());		vpartP.push_back( partP );//+Pt Uncertainty
	 partP.SetPtEtaPhiE(L22P4.Pt()-safeAccess(RECOMU_mubesttrkPTError)[indexleptonfinal[3]],L22P4.Eta(),L22P4.Phi(),L22P4.E());		vpartP.push_back( partP );//-Pt Uncertainty
	 vpartsP.push_back( vpartP );
	 ...
	 f_Djet_VAJHU_UncDn =-1;
       ...
       // if (njets_pass>=2) {
       // 	 bnn_file << safeAccess(RECO_PFJET_PT)[jet1] << " " << safeAccess(RECO_PFJET_ETA)[jet1] << " " << safeAccess(RECO_PFJET_PHI)[jet1] << " " << safeAccess(RECO_PFJET_ET)[jet1] << " ";
       // 	 bnn_file << safeAccess(RECO_PFJET_PT)[jet2] << " " << safeAccess(RECO_PFJET_ETA)[jet2] << " " << safeAccess(RECO_PFJET_PHI)[jet2] << " " << safeAccess(RECO_PFJET_ET)[jet2] << " " 
     ...
     if ( abs(mass4l-125.)<=10. && pass_METFilters){ 
       ++N_8_a;
     ...
     if ( abs(mass4l-Zmass)<=10. && pass_METFilters){ 
       ++N_8_b;
     ...
     //Add also MET FILTERS Reham
     // Step 9: signal enriched variables
     if ( abs(mass4l-125.)<=10. && RECO_PFMET>=50. &&  pass_METFilters){ 
       ++N_9_PFMET;
     ...
     if (abs(mass4l-125.)<=10. && N_good==4 && n_bjets<=1 && pass_METFilters) {
       ++N_10;
	 ...
	 if( i == 0){
	   hPtLep1_10->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;	   
	 }
	 if( i == 1){
	   hPtLep2_10->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;	  
	 }
	 if( i == 2){
	   hPtLep3_10->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 }
	 if( i == 3){
	   hPtLep4_10->Fill( safeAccess(RECOMU_PT)[ ipt[i] ],newweight ) ;
	 }
	 
       }//end fill leptons
     }

     if (abs(mass4l-125.)<=10. && N_good==4 && n_bjets<=1 && RECO_PFMET>=50. &&  pass_METFilters) {
       ++N_11;
     ...
     if (debug) for(unsigned int i=0; i< 4; i++) output_txt << "\t mu[" << i << "] pT: " << safeAccess(RECOMU_PT)[indexleptonfinal[i]] << "\t eta: " <<  safeAccess(RECOMU_ETA)[indexleptonfinal[i]] << "\t phi: " <<  safeAccess(RECOMU_PHI)[indexleptonfinal[i]] << endl;
...
double HZZ4LeptonsAnalysis::EAele(int index,bool use2011EA){
  ...
  if (use2011EA){
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 0.0   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 1.0 )   EffectiveArea = 0.18;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 1.0   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 1.479 ) EffectiveArea = 0.20;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 1.479 && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 2.0 )   EffectiveArea = 0.15;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 2.0   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 2.2 )   EffectiveArea = 0.19;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 2.2   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 2.3 )   EffectiveArea = 0.21;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 2.3   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 2.4 )   EffectiveArea = 0.22;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 2.4 )                                       EffectiveArea = 0.29;
  }
  //else { // 7_4_x use eta
  // if (fabs(safeAccess(RECOELE_ETA)[index]) >= 0.0   && fabs(safeAccess(RECOELE_ETA)[index]) < 0.8 )   EffectiveArea = 0.1830;
  // if (fabs(safeAccess(RECOELE_ETA)[index]) >= 0.8   && fabs(safeAccess(RECOELE_ETA)[index]) < 1.3 )   EffectiveArea = 0.1734;
  // if (fabs(safeAccess(RECOELE_ETA)[index]) >= 1.3   && fabs(safeAccess(RECOELE_ETA)[index]) < 2.0 )   EffectiveArea = 0.1077;
  // if (fabs(safeAccess(RECOELE_ETA)[index]) >= 2.0   && fabs(safeAccess(RECOELE_ETA)[index]) < 2.2 )   EffectiveArea = 0.1565;
  // if (fabs(safeAccess(RECOELE_ETA)[index]) >= 2.2 )                                       EffectiveArea = 0.2680;
  //}                                                                                                                                                                             
  else { // 7_6_X use eta supercluster                                                                                                                                            
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 0.0   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 1.0 )   EffectiveArea = 0.1752;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 1.0   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 1.479 ) EffectiveArea = 0.1862;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 1.479 && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 2.0 )   EffectiveArea = 0.1411;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 2.0   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 2.2 )   EffectiveArea = 0.1534;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 2.2   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 2.3 )   EffectiveArea = 0.1903;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 2.3   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 2.4 )   EffectiveArea = 0.2243;
    if (fabs(safeAccess(RECOELE_scl_Eta)[index]) >= 2.4   && fabs(safeAccess(RECOELE_scl_Eta)[index]) < 5.0  )  EffectiveArea = 0.2687;
  }
