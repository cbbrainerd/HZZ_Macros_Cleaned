...
// Mon Oct 21 09:46:55 2019 by ROOT version 6.10/09
// from TTree HZZ4LeptonsAnalysis/HZZ4Leptons Analysis Tree
// found on file: MC_roottree_leptons_sync_new.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MC_roottree_leptons_sync_new.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MC_roottree_leptons_sync_new.root");
      }
