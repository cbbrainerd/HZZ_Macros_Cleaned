...
// Mon May 13 13:57:42 2019 by ROOT version 6.17/01
// from TTree HZZ4LeptonsAnalysis/HZZ4Leptons Analysis Tree
// found on file: roottree_leptons_sync.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *MC_ZZ_PDGID;
   vector<vector<float> > *MC_ZZ_D_MASS;
   vector<vector<float> > *MC_ZZ_D_PT;
   vector<vector<float> > *MC_ZZ_D_ETA;
   vector<vector<float> > *MC_ZZ_D_PHI;
   vector<vector<float> > *MC_ZZ_D_THETA;
   vector<vector<float> > *MC_ZZ_D_PDGID;
   vector<vector<vector<float> > > *MC_ZZ_DD_MASS;
   vector<vector<vector<float> > > *MC_ZZ_DD_PT;
   vector<vector<vector<float> > > *MC_ZZ_DD_ETA;
   vector<vector<vector<float> > > *MC_ZZ_DD_PHI;
   vector<vector<vector<float> > > *MC_ZZ_DD_THETA;
   vector<vector<vector<float> > > *MC_ZZ_DD_PDGID;
   ...
   vector<int>     *RECOMU_isPFMu;
   vector<int>     *RECOMU_isGlobalMu;
   vector<int>     *RECOMU_isStandAloneMu;
   vector<int>     *RECOMU_isTrackerMu;
   vector<int>     *RECOMU_isCaloMu;
   vector<int>     *RECOMU_isTrackerHighPtMu;
   vector<int>     *RECOMU_isME0Muon;
   ...
   vector<vector<float> > *StdFitVertexTrack_PT;
   vector<vector<float> > *StdFitVertexTrack_ETA;
   vector<vector<float> > *StdFitVertexTrack_PHI;
   ...
   vector<vector<float> > *StdFitVertexTrackMMMM_PT;
   vector<vector<float> > *StdFitVertexTrackMMMM_ETA;
   vector<vector<float> > *StdFitVertexTrackMMMM_PHI;
   ...
   vector<vector<float> > *StdFitVertexTrackEEEE_PT;
   vector<vector<float> > *StdFitVertexTrackEEEE_ETA;
   vector<vector<float> > *StdFitVertexTrackEEEE_PHI;
   ...
   HZZ4LeptonsAnalysis(TTree *tree=0);
...
HZZ4LeptonsAnalysis::HZZ4LeptonsAnalysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("roottree_leptons_sync.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("roottree_leptons_sync.root");
      }
