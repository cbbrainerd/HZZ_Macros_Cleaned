...
// Sun Jun  7 19:07:07 2020 by ROOT version 6.12/07
// from TTree HZZ4LeptonsAnalysis/HZZ4Leptons Analysis Tree
// found on file: roottree_leptons_5.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("roottree_leptons_5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("roottree_leptons_5.root");
      }
